                    ...
                    <div class="d-flex flex-column-fluid">
                        ...
                        <div class="container-fluid dashboard">
                            <div class="example-preview">
                                <span class="font-size-h5">Loan Application Sub Status</span>
                                ...
                                <div class="row mt-10">
                                    ...
                                    <div class="col-6"></div>
                                    <div class="col-2">
                                        <a data-toggle="modal" data-target="#exampleEditNotification"><span class="con-xs la la-pen btn-sm btn-primary font-size-h4 text-white" /></a>
                                        <a href="./master_email_notification.php"><span class="con-xs la la-envelope btn-sm btn-primary font-size-h4 text-white" /></a>
                                        <a href="./user_page.php"><span class="con-xs la la-trash btn-sm btn-danger font-size-h4 text-white" /></a>
                                    </div>
                                </div>
                                <div class="row mt-5">
                                    <div class="col-4">
                                ...
                                <span class="mt-10 font-size-h5">Loan Status</span>
                                ...
                                <br />
                                <br />
                                <span class="font-size-h5">Collection Of Payment</span>
                                ...
                                <br />
                                <br />
                                <span class="font-size-h5">Past Due</span>
                                ...
                                <br />
                                <br />
                                <span class="font-size-h5">Due Date</span>
                                <div class="row mt-10">
                                    <div class="col-4">
                                ...
                                <div class="row mt-10">
                                    ...
                                    <div class="col-2">
                                    <a data-toggle="modal" data-target="#exampleEditNotification"><span class="con-xs la la-pen btn-sm btn-primary font-size-h4 text-white" /></a>
                                        <a href="./Edit_customer.php"><span class="con-xs la la-envelope btn-sm btn-primary font-size-h4 text-white" /></a>
                                        <a href="./user_page.php"><span class="con-xs la la-trash btn-sm btn-danger font-size-h4 text-white" /></a>
                                    </div>
                                </div>
                                <div class="row mt-10">
                                ...
                                <div class="row mt-10">
                                    ...
                                    <a data-toggle="modal" data-target="#exampleEditNotification"><span class="con-xs la la-pen btn-sm btn-primary font-size-h4 text-white" /></a>
                                        <a href="./master_email_notification.php"><span class="con-xs la la-envelope btn-sm btn-primary font-size-h4 text-white" /></a>
                                        <a href="./master_email_notification.php"><span class="con-xs la la-trash btn-sm btn-danger font-size-h4 text-white" /></a>
                                    </div>
                                </div>
                                <br />
                                <br />
                                ...
                                <br />
                                <br />
                                <span class="font-size-h5">Rollover</span>
                                <div class="row mt-10">
                                    <div class="col-4">
                            ...
                            <div class="modal fade" id="exampleEditNotification" tabindex="-1" role="dialog" aria-hidden="true">
                                    ...
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-body">
                                            <div class="row">
                                                <div class="col-9">
                                                    <div class="form-group col">
                                                        <span class="font-size-h5">Notification Type</span>

                                                        <select class="form-control font-size-h5 mt-2" id="exampleSelect1">
                                                            <option>General</option>
                                                            <option>Loan Application Sub Status</option>
                                                            <option>Loan Status</option>
                                                            <option>Collection of Payments</option>
                                            ...
                                            <div class="row">
                                                <div class="col-9">
                                                    <div class="form-group col">
                                                        <span class="font-size-h5">Name</span>
                                                        <br/>

                                                       <input type="text" class="form-control mt-2" placeholder="EmailSMS"/>
                                                    </div>
                                                </div>
                                            ...
                                            <div class="row">
                                                <div class="col-9">
                                                    <div class="form-group col">
                                                        <span class="font-size-h5">Notify Before or After</span>
                                                        <select class="form-control font-size-h5 mt-2" id="exampleSelect1">
                                            ...
                                            <div class="row">
                                                <div class="col-9">
                                                    <div class="form-group col">
                                                        <span class="font-size-h5">How many days before the day of notice ?</span>
                                                        <br/>
                                            ...
                                            <div class="row">
                                                <div class="col-9">
                                                    <div class="form-group col">
                                                        <span class="font-size-h5">Description</span>
                                                        <br/>
