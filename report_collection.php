                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-3">
                                                        ...
                                                        <div class="input-group date">
                                                            <a href="#assignToPop" data-toggle="modal" class="btn btn-primary btn-lg btn-block font-weight-bold font-size-base text-muted">
                                                                Submit
                                                            </a>
                                                        </div>
                                                    </div>
                                            ...
                                            <div class="row">
                                                <div class="col-sm-12">
                                                    <table class="table table-separate table-head-custom table-checkable dataTable no-footer dtr-inline collapsed" id="kt_datatable" role="grid" aria-describedby="kt_datatable_info" style="width: 100%;">
                                                        <thead>
                                                            <tr role="row">
                                                                <th class="sorting sorting_asc" tabindex="0" aria-controls="kt_datatable" rowspan="1" colspan="1" style="width: 80px;" aria-sort="ascending" aria-label="Record ID: activate to sort column descending">LID</th>
                                                                <th class="sorting" tabindex="0" aria-controls="kt_datatable" rowspan="1" colspan="1" style="width: 80px;" aria-label="Order ID: activate to sort column ascending">Customer Name</th>
                                                                <th class="sorting" tabindex="0" aria-controls="kt_datatable" rowspan="1" colspan="1" style="width: 80px;" aria-label="Country: activate to sort column ascending">Email</th>
                                                                <th class="sorting" tabindex="0" aria-controls="kt_datatable" rowspan="1" colspan="1" style="width: 120px;" aria-label="Ship City: activate to sort column ascending">Payment Scheduled Date</th>
                                                                <th class="sorting" tabindex="0" aria-controls="kt_datatable" rowspan="1" colspan="1" style="width: 80px;" aria-label="Ship Address: activate to sort column ascending">Status</th>
                                                            </tr>
                                                        </thead>
                                                        <tbody>
                                                            <tr>
