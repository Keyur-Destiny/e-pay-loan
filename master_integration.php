                        ...
                        <div class="col-xl-12">
                            <div class="example-code">
                                <ul class="example-nav nav nav-tabs nav-tabs-line nav-tabs-line-2x font-size-h6 nav-tabs-primary" id="myTab" role="tablist">
                                    <li class="nav-item">
                                        <a class="nav-link active text-center" data-toggle="tab" href="#mobile_verification">Mobile Verification</a>
                                    </li>
                                    <li class="nav-item text-center">
                                        <a class="nav-link" data-toggle="tab" href="#email_notification">Email Notification</a>
                                    </li>

                                    <li class="nav-item text-center">
                                        <a class="nav-link" data-toggle="tab" href="#bank_verification">Bank Verification(IBV)</a>
                                    </li>
                                    <li class="nav-item text-center">
                                        <a class="nav-link" data-toggle="tab" href="#credit_bureau">Credit Bureau</a>
                                    </li>
                                    <li class="nav-item text-center">
                                        <a class="nav-link" data-toggle="tab" href="#signature">Signature API</a>
                                    </li>
                                    <li class="nav-item text-center">
                                        <a class="nav-link" data-toggle="tab" href="#payment">Payment</a>
                                    </li>
                                    <li class="nav-item text-center">
                                        <a class="nav-link" data-toggle="tab" href="#live_notification">Live Notification</a>
                                    </li>
                                    <li class="nav-item text-center">
                                        <a class="nav-link" data-toggle="tab" href="#google_tag">Google Tag</a>
                                    </li>
                                    <li class="nav-item text-center">
                                        <a class="nav-link" data-toggle="tab" href="#SMS_notification">SMS Notification</a>
                                    </li>
                                    <li class="nav-item text-center">
                                        <a class="nav-link" data-toggle="tab" href="#lead_exchange">Lead Exchange</a>
                                    </li>
                                    <li class="nav-item text-center">
                                        <a class="nav-link" data-toggle="tab" href="#edge">Edge</a>
                                    </li>
                                </ul>
                                <div class="tab-content">

                                    <div class="tab-pane active" id="mobile_verification" role="tabpanel">
                                        <form class="form">
                                            <div class="card-body">
                                                <div class="mb-15">
                                                    ...
                                                    <div class="form-group row">
                                                        <label class="col-lg-3 col-form-label">Twilo_SID</label>
                                                        <div class="col-lg-6">
                                                            <input type="text" class="form-control" placeholder="TWILO_SID" />
                                                        </div>
                                                    </div>
                                                    <div class="form-group row">
                                                        <label class="col-lg-3 col-form-label">TWILO_AUTH_TOCKEN</label>
                                                        <div class="col-lg-6">
                                                            <input type="text" class="form-control" placeholder="Twilo_AUTH_TOCKEN" />
                                                        </div>
                                                    </div>
                                                    <div class="form-group row">
                                                        <label class="col-lg-3 col-form-label">TWILO_VERIFY_SID</label>
                                                        <div class="col-lg-6">
                                                            <input type="text" class="form-control" placeholder="TWILO_VERIFY_SID" />
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="form-group row">
                                                        <label class="col-lg-3 col-form-label"><input type="submit" class="btn btn-primary"/></label>
                                                        <div class="col-lg-6">
                                                        </div>
                                            </div>
                                        </form>
                                    ...
                                    <div class="tab-pane" id="email_notification" role="tabpanel">
                                        <form class="form">
                                            <div class="card-body">
                                                <div class="mb-15">
                                                    <div class="form-group row">
                                                    ...
                                                    <div class="form-group row">
                                                        <label class="col-lg-3 col-form-label">MAIL_HOST</label>
                                                        <div class="col-lg-6">
                                                            <input type="text" class="form-control" placeholder="MAIL_HOST" />
                                                        </div>
                                                    </div>
                                                    <div class="form-group row">
                                                        <label class="col-lg-3 col-form-label">MAIL_PORT</label>
                                                        <div class="col-lg-6">
                                                            <input type="text" class="form-control" placeholder="MAIL_PORT" />
                                                        </div>
                                                    </div>
                                                    <div class="form-group row">
                                                        <label class="col-lg-3 col-form-label">MAIL_MAILER</label>
                                                        <div class="col-lg-6">
                                                            <input type="text" class="form-control" placeholder="MAIL_MAILER" />
                                                        </div>
                                                    </div>
                                                    <div class="form-group row">
                                                        <label class="col-lg-3 col-form-label">MAIL_PASSWORD</label>
                                                        <div class="col-lg-6">
                                                            <input type="text" class="form-control" placeholder="MAIL_PASSWORD" />
                                                        </div>
                                                    </div>
                                                    <div class="form-group row">
                                                        <label class="col-lg-3 col-form-label">MAIL_USERNAME</label>
                                                        <div class="col-lg-6">
                                                            <input type="text" class="form-control" placeholder="MAIL_USERNAME" />
                                                        </div>
                                                    </div>
                                                    <div class="form-group row">
                                                        <label class="col-lg-3 col-form-label">MAIL_ENCRYPTION</label>
                                                        <div class="col-lg-6">
                                                            <input type="text" class="form-control" placeholder="MAIL_ENCRYPTION" />
                                                        </div>
                                                    </div>
                                                    <div class="form-group row">
                                                        <label class="col-lg-3 col-form-label">MAIL_FROM_ADDRESS</label>
                                                        <div class="col-lg-6">
                                                            <input type="text" class="form-control" placeholder="MAIL_FROM_ADDRESS" />
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                                    ...
                                    <div class="tab-pane" id="bank_verification" role="tabpanel">
                                        <form class="form">
                                            <div class="card-body">
                                                <div class="mb-15">
                                                    <div class="form-group row">
                                                        ...
                                                        <div class="col-lg-6">
                                                            <select class="form-control" id="exampleSelect1">
                                                                <option>Flinks</option>
                                                                <option>Inverite</option>
                                                                <option>Zumrails</option>
                                                                <option>CreditSense</option>
                                                            </select>
                                                        </div>
                                                    </div>
                                                    <div class="form-group row">
                                                        ...
                                                        <div class="col-lg-6">
                                                            <input type="text" class="form-control" placeholder="SECRET" />
                                                        </div>
                                                    </div>
                                                    <div class="form-group row">
                                                        <label class="col-lg-3 col-form-label">INSTANCE</label>
                                                        <div class="col-lg-6">
                                                            <input type="text" class="form-control" placeholder="INSTANCE" />
                                                        </div>
                                                    </div>
                                                    <div class="form-group row">
                                                        <label class="col-lg-3 col-form-label">IFRAME_URL</label>
                                                        <div class="col-lg-6">
                                                            <input type="text" class="form-control" placeholder="IFRAME_URL" />
                                                        </div>
                                                    </div>
                                                    <div class="form-group row">
                                                        <label class="col-lg-3 col-form-label">CUSTOMER_ID</label>
                                                        <div class="col-lg-6">
                                                            <input type="text" class="form-control" placeholder="CUSTOMER_ID" />
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                                    ...
                                    <div class="tab-pane" id="credit_bureau" role="tabpanel">
                                        <form class="form">
                                            <div class="card-body">
                                                <div class="mb-15">
                                                    <div class="form-group row">
                                    ...
                                    <div class="tab-pane ave" id="signature" role="tabpanel">
                                        <form class="form">
                                            <div class="card-body">
                                                <div class="mb-15">
                                                    <div class="form-group row">
                                                    ...
                                                    <div class="form-group row">
                                                        <label class="col-lg-3 col-form-label">POSTBACK_URL</label>
                                                        <div class="col-lg-6">
                                                            <input type="text" class="form-control" placeholder="POSTBACK_URL" />
                                                        </div>
                                                    </div>
                                                    <div class="form-group row">
                                                        <label class="col-lg-3 col-form-label">BASIC_AUTH_TOKEN</label>
                                                        <div class="col-lg-6">
                                                            <input type="text" class="form-control" placeholder="BASIC_AUTH_TOKEN" />
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                                    ...
                                    <div class="tab-pane ave" id="payment" role="tabpanel">
                                        <form class="form">
                                            <div class="card-body">
                                                <div class="mb-15">
                                                    <div class="form-group row">
                                                    ...
                                                    <div class="form-group row">
                                                        <label class="col-lg-3 col-form-label">ENV</label>
                                                        <div class="col-lg-6">
                                                    ...
                                                    <div class="form-group row">
                                                        <label class="col-lg-3 col-form-label">WEBHOOCK_SECRET</label>
                                                        <div class="col-lg-6">
                                                            <input type="text" class="form-control" placeholder="WEBHOOCK_SECRET" />
                                                        </div>
                                                    </div>
                                                    <div class="form-group row">
                                                        <label class="col-lg-3 col-form-label"><input type="submit" class="btn btn-primary"/></label>
                                    ...
                                    <div class="tab-pane ave" id="live_notification" role="tabpanel">
                                        <form class="form">
                                            <div class="card-body">
                                                <div class="mb-15">
                                                    <div class="form-group row">
                                                    ...
                                                    <div class="form-group row">
                                                        <label class="col-lg-3 col-form-label">PUSHER_APP_ID</label>
                                                        <div class="col-lg-6">
                                                            <input type="text" class="form-control" placeholder="PUSHER_APP_ID" />
                                                        </div>
                                                    </div>
                                                    <div class="form-group row">
                                                        <label class="col-lg-3 col-form-label">PUSHER_APP_KEY</label>
                                                        <div class="col-lg-6">
                                                            <input type="text" class="form-control" placeholder="PUSHER_APP_ID" />
                                                        </div>
                                                    </div>
                                                    <div class="form-group row">
                                                        <label class="col-lg-3 col-form-label">PUSHER_APP_SECRET</label>
                                                        <div class="col-lg-6">
                                                            <input type="text" class="form-control" placeholder="PUSHER_APP_SECRET" />
                                                        </div>
                                                    </div>
                                                    <div class="form-group row">
                                                        <label class="col-lg-3 col-form-label">PUSHER_APP_CLUSTER</label>
                                                        <div class="col-lg-6">
                                                            <input type="text" class="form-control" placeholder="PUSHER_APP_CLUSTER" />
                                                        </div>
                                                    </div>
                                                    <div class="form-group row">
                                                        <label class="col-lg-3 col-form-label"><input type="submit" class="btn btn-primary"/></label>
                                    ...
                                    <div class="tab-pane ave" id="google_tag" role="tabpanel">
                                        <form class="form">
                                            <div class="card-body">
                                                <div class="mb-15">
                                                    <div class="form-group row">
                                                    ...
                                                    <div class="form-group row">
                                                        <label class="col-lg-3 col-form-label">GMT_ID</label>
                                                        <div class="col-lg-6">
                                                            <input type="text" class="form-control" placeholder="GMT_ID" />
                                                        </div>
                                                    </div>
                                                    <div class="form-group row">
                                                        <label class="col-lg-3 col-form-label"><input type="submit" class="btn btn-primary"/></label>
                                    ...
                                    <div class="tab-pane ave" id="SMS_notification" role="tabpanel">
                                        <form class="form">
                                            <div class="card-body">
                                                <div class="mb-15">
                                                    <div class="form-group row">
                                                    ...
                                                    <div class="form-group row">
                                                        <label class="col-lg-3 col-form-label">TWILIO_SID</label>
                                                        <div class="col-lg-6">
                                                            <input type="text" class="form-control" placeholder="TWILIO_SID" />
                                                        </div>
                                                    </div>
                                                    <div class="form-group row">
                                                        <label class="col-lg-3 col-form-label">TWILIO_AUTH_TOKEN</label>
                                                        <div class="col-lg-6">
                                                            <input type="text" class="form-control" placeholder="TWILIO_AUTH_TOKEN" />
                                                        </div>
                                                    </div>
                                                    <div class="form-group row">
                                                        <label class="col-lg-3 col-form-label">TWILIO_VERIFY_SID</label>
                                                        <div class="col-lg-6">
                                                            <input type="text" class="form-control" placeholder="TWILIO_VERIFY_SID" />
                                                        </div>
                                                    </div>
                                                    <div class="form-group row">
                                                        <label class="col-lg-3 col-form-label"><input type="submit" class="btn btn-primary"/></label>
                                    ...
                                    <div class="tab-pane ave" id="lead_exchange" role="tabpanel">
                                        <form class="form">
                                            <div class="card-body">
                                                <div class="mb-15">
                                                    <div class="form-group row">
                                                        ...
                                                        <div class="col-lg-6">
                                                            <select class="form-control" id="exampleSelect1">
                                                                <option>Credit Sense-Lead Exchange</option>
                                                            </select>
                                                        </div>
                                                    </div>
                                                    <div class="form-group row">
                                                    ...
                                                    <div class="form-group row">
                                                        <label class="col-lg-3 col-form-label">API_KEY</label>
                                                        <div class="col-lg-6">
                                                            <input type="text" class="form-control" placeholder="API_KEY" />
                                                        </div>
                                                    </div>
                                                    <div class="form-group row">
                                                        <label class="col-lg-3 col-form-label">API_TOKEN</label>
                                                        <div class="col-lg-6">
                                                            <input type="text" class="form-control" placeholder="API_TOKEN" />
                                                        </div>
                                                    </div>
                                                    <div class="form-group row">
                                                        <label class="col-lg-3 col-form-label">CUSTOMER_ID</label>
                                                    ...
                                                    <div class="form-group row">
                                                        <label class="col-lg-3 col-form-label">SMART_CAMPAIGN_ID</label>
                                                        <div class="col-lg-6">
                                                            <input type="text" class="form-control" placeholder="SMART_CAMPAIGN_ID" />
                                                        </div>
                                                    </div>
                                                    <div class="form-group row">
                                                        <label class="col-lg-3 col-form-label"><input type="submit" class="btn btn-primary"/></label>
                                    ...
                                    <div class="tab-pane ave" id="edge" role="tabpanel">
                                        <form class="form">
                                            <div class="card-body">
                                                <div class="mb-15">
                                                    <div class="form-group row">
