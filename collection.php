                        ...
                        <div class="container-fluid dashboard">
                                        ...
                                        <div class="row">
                                                ...
                                                <div class="card card-custom card-stretch gutter-b">
                                                    ...
                                                    <div class="card-body d-flex align-items-center py-0">
                                                        <div class="d-flex flex-column">
                                                            <a href="#" class="card-title font-weight-bolder text-dark-75 font-size-h5 mb-2 text-hover-primary">Completed Payments</a>
                                                            <img src="assets/media/svg/icons/Code/Done-circle.svg" alt="" class="align-self-end h-40px filter-green" />

                                                            <h3 class="font-weight-bold text-muted  font-size-h3">0</span>
                                                                <h4 class="font-weight-bold text-muted  font-size-h4">$0</span>
                                                        </div>
                                            ...
                                            <div class="col-3">
                                                ...
                                                <div class="card card-custom card-stretch gutter-b">
                                                    ...
                                                    <div class="card-body d-flex align-items-center py-0">
                                                        <div class="d-flex flex-column">
                                                            <a href="#" class="card-title font-weight-bolder text-dark-75 font-size-h5 mb-2 text-hover-primary">Failed Payments</a>
                                                            <img src="assets/media/svg/icons/General/alert-hexagon.svg" alt="" class="align-self-end h-40px filter-green" />
                                            ...
                                            <div class="col-3">
                                                ...
                                                <div class="card card-custom card-stretch gutter-b">
                                                    ...
                                                    <div class="card-body d-flex align-items-center py-0">
                                                        <div class="d-flex flex-column">
                                                            <a href="#" class="card-title font-weight-bolder text-dark-75 font-size-h5 mb-2 text-hover-primary">Cancelled Payments</a>
                                            ...
                                            <div class="col-3">
                                                ...
                                                <div class="card card-custom card-stretch gutter-b">
                                                    ...
                                                    <div class="card-body d-flex align-items-center py-0">
                                                        <div class="d-flex flex-column">
                                                            <a href="#" class="card-title font-weight-bolder text-dark-75 font-size-h5 mb-2 pl-5 pr-5 text-hover-primary">Portfolio</a>
                                                            <img src="assets/media/svg/icons/General/hand-holding.svg" alt="" class="align-self-end h-35px" />
                            ...
                            <a href="#" class="btn btn-light-primary px-6 font-weight-bold mb-3">
                                Search
                                                    ...
                                                    <div class="col-xs-1">
                                                        <span class="font-size-base text-dark">From</span>
                                                    ...
                                                    <div class="col-xs-1">
                                                        <span class="font-size-base text-dark">To</span>
