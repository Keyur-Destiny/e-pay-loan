                                                ...
                                                <div class="card card-custom card-stretch gutter-b">
                                                    ...
                                                    <div class="card-body d-flex py-0">
                                                        ...
                                                        <div class="d-flex flex-column">
                                                            <div>
                                                               <span class="font-size-h6 text-muted">New<br/>Customers</span>
                                                            </div>
                                                            <br/>
                                            ...
                                            <div class="col-2">
                                                ...
                                                <div class="card card-custom card-stretch gutter-b">
                                                    ...
                                                    <div class="card-body d-flex py-0">
                                                        ...
                                                        <div class="d-flex flex-column">
                                                            <div>
                                                               <span class="font-size-h6 text-muted">Existing<br/>Customers</span>
                                                            </div>
                                                            <br/>
                                                            <h3 class="font-weight-bold text-dark  font-size-h3">0</span>
                                                        </div>
                                            ...
                                            <div class="col-2">
                                                ...
                                                <div class="card card-custom card-stretch gutter-b">
                                                    ...
                                                    <div class="card-body d-flex py-0">
                                                        ...
                                                        <div class="d-flex flex-column">
                                                            <div>
                                                               <span class="font-size-h6 text-muted">Total<br/>Loans</span>
                                                            </div>
                                                            <br/>
                                                            <h3 class="font-weight-bold text-dark  font-size-h3">0</span>
                                                        </div>
                                            ...
                                            <div class="col-2">
                                                ...
                                                <div class="card card-custom card-stretch gutter-b">
                                                    ...
                                                    <div class="card-body d-flex py-0">
                                                        ...
                                                        <div class="d-flex flex-column">
                                                            <div>
                                                               <span class="font-size-h6 text-muted">Paid Off<br/>Lons</span>
                                                            </div>
                                                            <br/>
                                                            <h3 class="font-weight-bold text-dark  font-size-h3">0</span>
                                                        </div>
                                            ...
                                            <div class="col-2">
                                                ...
                                                <div class="card card-custom card-stretch gutter-b">
                                                    ...
                                                    <div class="card-body d-flex py-0">
                                                        ...
                                                        <div class="d-flex flex-column">
                                                            <div>
                                                               <span class="font-size-h6 text-muted">Total<br/>Outstanding</span>
                                                            </div>
                                                            <br/>
                                                            <h3 class="font-weight-bold text-dark  font-size-h3">0</span>
                                                        </div>
                                            ...
                                            <div class="row">
                                                <div class="col-sm-12">
                                                    <table class="table table-separate table-head-custom table-checkable dataTable no-footer dtr-inline collapsed" id="kt_datatable" role="grid" aria-describedby="kt_datatable_info" style="width: 100%;">
                                                        <thead>
                                                            <tr role="row">
                                                                <th class="sorting sorting_asc" tabindex="0" aria-controls="kt_datatable" rowspan="1" colspan="1" style="width: 5%;" aria-sort="ascending" aria-label="Record ID: activate to sort column descending">ID</th>
                                                                <th class="sorting" tabindex="0" aria-controls="kt_datatable" rowspan="1" colspan="1" style="width: 5%;" aria-label="Order ID: activate to sort column ascending">Customer Name</th>
                                                                <th class="sorting" tabindex="0" aria-controls="kt_datatable" rowspan="1" colspan="1" style="width: 5%;" aria-label="Country: activate to sort column ascending">Loan Amount(including fees)</th>
                                                                <th class="sorting" tabindex="0" aria-controls="kt_datatable" rowspan="1" colspan="1" style="width: 5%;" aria-label="Ship City: activate to sort column ascending">Credit Product</th>
                                                                <th class="sorting" tabindex="0" aria-controls="kt_datatable" rowspan="1" colspan="1" style="width: 5%;" aria-label="Ship City: activate to sort column ascending">Start Date</th>
                                                                <th class="sorting" tabindex="0" aria-controls="kt_datatable" rowspan="1" colspan="1" style="width: 5%;" aria-label="Ship Address: activate to sort column ascending">End Date</th>
                                                                <th class="sorting" tabindex="0" aria-controls="kt_datatable" rowspan="1" colspan="1" style="width: 5%;" aria-label="Ship Address: activate to sort column ascending">Balance</th>
                                                                <th class="sorting" tabindex="0" aria-controls="kt_datatable" rowspan="1" colspan="1" style="width: 5%;" aria-label="Ship Address: activate to sort column ascending">Status</th>
                                                                <th class="sorting" tabindex="0" aria-controls="kt_datatable" rowspan="1" colspan="1" style="width: 5%;" aria-label="Ship Address: activate to sort column ascending">New/Existing Customers</th>
                                                            </tr>
                                                        </thead>
                                                        <tbody>
                                                            <tr>
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-sm-12 col-md-3 dataTables_pager">
                                                                ...
                                                                <div class="dataTables_paginate paging_simple_numbers" id="kt_datatable_paginate">
                                                                    <ul class="pagination">
                                                                        <li class="paginate_button page-item active"><a href="#" aria-controls="kt_datatable" data-dt-idx="1" tabindex="0" class="page-link">Pervious</a></li>
                                                                        <li class="paginate_button page-item "><a href="#" aria-controls="kt_datatable" data-dt-idx="2" tabindex="0" class="page-link">Next</a></li>
                                                                    </ul>
                                                                </div>
                                                            </div>
                                            </div>
