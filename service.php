                                                    ...
                                                    <div class="card-body d-flex py-0">
                                                        <div class="d-flex flex-column">
                                                            ...
                                                            <h3 class="font-weight-bold text-dark  font-size-h3">0</span>
                                                                <h4 class="font-weight-bold text-dark  font-size-h4">$0</span>
                                                        </div>
                                                ...
                                                <div class="row no-gutters">
                                                    ...
                                                    <div class="col-2 align-items-center">
                                                        ...
                                                        <div class="input-group date">
                                                            <a href="#assignToPop" data-toggle="modal" class="btn btn-light-primary px-4 font-weight-bold font-size-base">
                                                                Assign To
                                                            </a>
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="col-1">
                                                        ...
                                                        <div class="input-group date">
                                                            <a href="#" class="btn btn-light-primary px-4 font-weight-bold font-size-base text-muted">
                                                                Export
                                                            </a>
                                                        </div>
                                                    </div>
                                            ...
                                            <div class="row">
                                                <div class="col-sm-12">
                                                    <table class="table table-separate table-head-custom table-checkable dataTable no-footer dtr-inline collapsed" id="kt_datatable" role="grid" aria-describedby="kt_datatable_info" style="width: 100%;">
                                                        <thead>
                                                            <tr role="row">
                                                                <th class="sorting sorting_asc" tabindex="0" aria-controls="kt_datatable" rowspan="1" colspan="1" style="width: 80px;" aria-sort="ascending" aria-label="Record ID: activate to sort column descending"></th>
                                                                <th class="sorting" tabindex="0" aria-controls="kt_datatable" rowspan="1" colspan="1" style="width: 120px;" aria-label="Order ID: activate to sort column ascending"></th>
                                                                <th class="sorting" tabindex="0" aria-controls="kt_datatable" rowspan="1" colspan="1" style="width: 120px;" aria-label="Country: activate to sort column ascending">Loan ID</th>
                                                                <th class="sorting" tabindex="0" aria-controls="kt_datatable" rowspan="1" colspan="1" style="width: 120px;" aria-label="Ship City: activate to sort column ascending">Name</th>
                                                                <th class="sorting" tabindex="0" aria-controls="kt_datatable" rowspan="1" colspan="1" style="width: 120px;" aria-label="Ship Address: activate to sort column ascending">Product</th>
                                                                ...
                                                                <th class="sorting" tabindex="0" aria-controls="kt_datatable" rowspan="1" colspan="1" style="width: 140px;" aria-label="Company Name: activate to sort column ascending">Principal</th>
                                                                <th class="sorting" tabindex="0" aria-controls="kt_datatable" rowspan="1" colspan="1" style="width: 140px;" aria-label="Ship Date: activate to sort column ascending">Interest</th>
                                                                <th class="sorting" tabindex="0" aria-controls="kt_datatable" rowspan="1" colspan="1" style="width: 140px;" aria-label="Ship Date: activate to sort column ascending">Fees</th>
                                                                <th class="sorting" tabindex="0" aria-controls="kt_datatable" rowspan="1" colspan="1" style="width: 140px;" aria-label="Ship Date: activate to sort column ascending">Term</th>
                                                                <th class="sorting" tabindex="0" aria-controls="kt_datatable" rowspan="1" colspan="1" style="width: 140px;" aria-label="Ship Date: activate to sort column ascending">Created On</th>
                                                                <th class="sorting" tabindex="0" aria-controls="kt_datatable" rowspan="1" colspan="1" style="width: 140px;" aria-label="Ship Date: activate to sort column ascending">Agent</th>
                                                                <th class="sorting" tabindex="0" aria-controls="kt_datatable" rowspan="1" colspan="1" style="width: 140px;" aria-label="Ship Date: activate to sort column ascending">Status</th>
                                                        ...
                                                        <tbody>
                                                            <tr>
                                                                ...
                                                                <td>
                                                                    ...
                                                                    <a href="./customer_info.php"> <span class="con-xs la la-eye font-size-h3 text-dark" /></a>
                                                ...
                                                <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                                                    <a class="dropdown-item font-size-h6 text-dark" href="#">Refresh IBV Request</a>
                                                </div>
                                                </td>
                                                </tr>
                                                </tbody>
