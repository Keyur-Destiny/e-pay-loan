...
<div class="d-flex flex-column flex-root">
    ...
    <div class="login login-2 login-signin-on d-flex flex-column flex-lg-row flex-column-fluid bg-white" id="kt_login">
        ...
        <div class="login-aside order-2 order-lg-1 d-flex flex-row-auto position-relative overflow-hidden">
            ...
            <div class="d-flex flex-column-fluid flex-column justify-content-between py-9 py-lg-13 px-lg-35">
                <!--begin::Logo-->
                <a href="#" class="text-center pt-2">
                    <img src="assets/media/logos/epayloan-favicon.png" class="max-h-75px" alt=""/>
                </a>
                <!--end::Logo-->

                <!--begin::Aside body-->
                <div class="d-flex flex-column-fluid flex-column flex-center pt-2">
                    <!--begin::Signin-->
                        ...
                        <form class="form" action="./ind" id="kt_login_signin_form">
                            ...
                            <div class="text-center pb-8">
                                <h2 class="font-weight-bolder font-size-h2 font-size-h1-lg">Welcome Back
                                    !</h2>
                                <span class="text-muted font-weight-bold font-size-h4">Sign in to continue to [TRIAL] ePay Loan.</span>
                            </div>
                            <!--end::Title-->
                            ...
                            <div class="form-group" style="padding-top:20%;">
                                ...
                                <!--                            <input class="form-control form-control-solid h-auto py-7 px-6 rounded-lg" type="text" name="username" placeholder="Email" autocomplete="off"/>-->
                            ...
                            <div class="form-group">
                                ...
                                <span class="text-muted font-weight-bold font-size-h4">Remember me</span>
                            ...
                            <div class="text-center pt-4">
                                <a href="./reset_password.php"
                                   class="text-muted font-size-h6 font-weight-bolder text-hover-warning pt-5"
                                   >
                                    Forgot Password ?
                                </a>
                            </div>
                            ...
                            <div class="text-center pt-11">
                                ...
                                >
                                    Don't have account ?  <a href="./sign_up.php"
                    ...
                    <div class="login-form login-signup pt-11">
                        <!--begin::Form-->
                        <form class="form" action="demo1/dist/custom/pages/login/dashboard.html" novalidate="novalidate" id="kt_login_signup_form">
                            <!--begin::Title-->
                            <div class="text-center pb-8">
        ...
        <div class="content order-1 order-lg-2 d-flex flex-column w-100 pb-0" style="background-color: #eab676;">
            ...
            <div class="d-flex flex-column justify-content-center text-right px-7">
                <a href="custom/pages/login/sign-up.html">
                    <i class="fa fa-home" aria-hidden="true" style="font-size: 3em;color:#ffff;"></i>
                </a>
            </div>
            <!--end::Title-->
