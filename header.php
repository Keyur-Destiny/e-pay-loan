<div id="kt_header" class="header  header-fixed ">
                    ...
                    <div class="container-fluid d-flex align-items-stretch justify-content-between">
                        <div class="d-flex top-search-sec">
                            <div class="form-group sel-term">
                        ...
                        <div class="topbar">
                            ...
                            <div class="dropdown">
                                ...
                                <div class="topbar-item" data-toggle="dropdown" data-offset="10px,0px">
                                    <div class="btn btn-icon btn-clean btn-dropdown btn-lg mr-1">
                                        <span class="svg-icon svg-icon-primary svg-icon-2x"><!--begin::Svg Icon | path:C:\wamp64\www\keenthemes\themes\metronic\theme\html\demo1\dist/../src/media/svg/icons\Navigation\Left-2.svg--><svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="24px" height="24px" viewBox="0 0 24 24" version="1.1">
                            ...
                            <div class="dropdown">
                                ...
                                <div class="topbar-item" data-toggle="dropdown" data-offset="10px,0px">
                                    <div class="btn btn-icon btn-clean btn-dropdown btn-lg mr-1 pulse pulse-primary">
                                        <span class="svg-icon svg-icon-primary svg-icon-xl"><svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="24px" height="24px" viewBox="0 0 24 24" version="1.1">
                                                <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
                                    ...
                                    <form>
                                        ...
                                        <div class="tab-content">
                                            ...
                                            <div class="tab-pane active show p-8" id="topbar_notifications_notifications" role="tabpanel">
                                                ...
                                                <!--begin::Action-->
                                                <div class="d-flex flex-center pt-7"><a href="./notification.php" class="btn btn-light-primary font-weight-bold text-center">See All</a></div>
                                                <!--end::Action-->
                                            </div>
                                            <!--end::Tabpane-->
                                        ...
                                        <div class="tab-content">
                                            ...
                                            <div class="tab-pane active show p-8"  id="topbar_notifications_notifications" role="tabpanel">
                                                <div class="row">
                                                    ...
                                                    <span><a href="./loan_application.php" class="custom-link"> Today's Applications </font></a></span>
                                                </div>
                                                    <div class="col-md-6 card"><span class="text-center"><i class="flaticon-calendar-with-a-clock-time-tools icon-md-2x"></i></span>
                                                    <span class="text-center">0</span>
                            ...
                            <div class="topbar-item">
                                <div class="btn btn-icon btn-icon-mobile w-auto btn-clean d-flex align-items-center btn-lg px-2" id="kt_quick_user_toggle">
                                    ...
                                    <span class="text-dark-50 font-weight-bolder font-size-base d-none d-md-inline mr-3">James Jones</span>
