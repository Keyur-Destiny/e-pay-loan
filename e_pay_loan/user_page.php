...
<body id="kt_body" class="header-fixed header-mobile-fixed subheader-enabled subheader-fixed aside-enabled aside-fixed aside-minimize-hoverable page-loading">
    ...
    <div class="d-flex flex-column flex-root">
        <!--begin::Page-->
        <div class="d-flex flex-row flex-column-fluid page wrapper">
                        ...
                        <div class="col-xl-4">
                            ...
                            <div class="card card-custom bgi-no-repeat bgi-size-cover gutter-b" style="height: 370px; background-color:#5969ca;">
                                ...
                                <div class="card-body d-flex flex-column">
                                    <!--begin::Title-->
                                    <img src="assets/media/svg/icons/Communication/Group.svg" height="50" width="50" class="mx-auto" />
                                    <br />
                                    <span class="text-center font-size-h2 text-white"><a href="./user_page.php" class="text-white"> Mike May </a></span>
                                    <img src="assets/media/svg/icons/Communication/Mail-notification.svg" height="30" width="30" class="mx-auto" />
                                    <span class="text-center font-size-h6 text-white">example@gmail.com</span>
                                    <span class="text-center font-size-h6 text-white">Phone: +1523697411</span>
                                    <div class="separator separator-solid mt-8 mb-5"></div>
                                    <br />
                                    <div class="row">
                                        <div class="col-6 text-center">
                                            <span class="text-center font-size-h6 text-white">Status</span>
                                            <br />
                                            <img src="assets/media/svg/icons/Communication/Shield-user.svg" />
                                            <img src="assets/media/svg/icons/Design/block-file.svg" height="20" width="20" class="text-white" />
                                            <i class="fa fa-user-lock"></i>
                                            <br />
                                            <img src="assets/media/svg/icons/Code/Warning-2.svg" height="20" width="20" class="mx-auto" />
                                        ...
                                        <div class="col-6 text-center">
                                            <span class="text-center font-size-h6 text-white">Sign up</span>
                                            <br />
                                            <span class="text-center font-size-h6 text-white">01-01-2013</span>
                                    ...
                                    <div class="row mt-5">
                                        <div class="col-3">
                                            <div class="d-flex justify-content-center">
                                                <i class="icon-4x la la-bank font-size-h1 text-dark"></i>
                                            </div>
                                            <br />
                                            ...
                                            <div class="text-center">
                                                ...
                                                <br />
                                                <span class="font-weight-bold font-size-sm mt-2">
                                                    01/01/2013 00:00:00
                                                </span>
                                        ...
                                        <div class="col-3">
                                            <div class="d-flex justify-content-center">
                                                <i class="icon-4x la la-dollar font-size-h1 text-dark"></i>
                                        ...
                                        <div class="col-3">
                                            <div class="d-flex justify-content-center">
                                                <i class="icon-4x la la-file font-size-h1 text-dark"></i>
                                        ...
                                        <div class="col-3">
                                            <div class="d-flex justify-content-center">
                                                <img src="assets/media/svg/icons/Code/Lock-overturning.svg" hight="50" width="50" />
                    ...
                    <div class="col-xl-12">
                        <div class="example-code">
                            <ul class="example-nav nav nav-tabs nav-tabs-line nav-tabs-line-2x font-size-h6 nav-tabs-primary" id="myTab" role="tablist">
                                <li class="nav-item">
                                    <a class="nav-link active text-center" data-toggle="tab" href="#example_code_1_html">Customer Info</a>
                                </li>
                                <li class="nav-item text-center">
                                    <a class="nav-link" data-toggle="tab" href="#example_code_1_js">Credit History</a>
                                </li>
                                <li class="nav-item text-center">
                                    <a class="nav-link" data-toggle="tab" href="#tab_bank_details">Bank Details</a>
                                </li>
                                <li class="nav-item text-center">
                                    <a class="nav-link" data-toggle="tab" href="#tab_insights_detail">Insights</a>
                                </li>
                                <li class="nav-item text-center">
                                    <a class="nav-link" data-toggle="tab" href="#tab_application_detail">Applications</a>
                                </li>
                                <li class="nav-item text-center">
                                    <a class="nav-link" data-toggle="tab" href="#tab_notes_detail">Notes</a>
                                </li>
                                <li class="nav-item text-center">
                                    <a class="nav-link" data-toggle="tab" href="#tab_documents">Documents</a>
                                </li>
                            </ul>
                            ...
                            <div class="tab-content">
                                <div class="tab-pane active" id="example_code_1_html" role="tabpanel">
                                    <div class="row">
                                        <div class="col-4">
                                            <span class="font-size-h4 text-dark"> Personal Info</span> <i class="icon-2x la la-pen font-size-h1 text-primary"></i>
                                            <hr class="hr border-2 border-bottom-dark" />
                                            <div class="row mt-2 mb-2">
                                                <div class="col-4">
                                                    <span class="text-left font-weight-bold text-black">
                                                        First <br />Name:
                                                    </span>
                                                </div>
                                                <div class="col-8">
                                                    <input type="text" id="first_name" class="form-control form-control-sm border border-primary" />
                                                </div>
                                            ...
                                            <div class="row mt-2 mb-2">
                                                ...
                                                <div class="col-8">
                                                    <input type="text" id="middle_name" class="form-control form-control-sm border border-primary" />
                                            ...
                                            <div class="row mt-2 mb-2">
                                                ...
                                                <div class="col-8">
                                                    <input type="text" id="last_name" class="form-control form-control-sm border border-primary" />
                                            ...
                                            <div class="row mt-2 mb-2">
                                                ...
                                                <div class="col-8">
                                                    <input type="text" id="email" class="form-control form-control-sm border border-primary" />
                                            ...
                                            <div class="row mt-2 mb-2">
                                                ...
                                                <div class="col-8">
                                                    <textarea class="form-control border border-primary" rows="2" placeholder="Type a message"></textarea>
                                            ...
                                            <div class="row mt-2 mb-2">
                                                ...
                                                <div class="col-8">
                                                    <input type="text" id="postal_code" class="form-control form-control-sm border border-primary" />
                                            ...
                                            <div class="row mt-2 mb-2">
                                                ...
                                                <div class="col-8">
                                                    <input type="number" id="year_at_address" class="form-control form-control-sm border border-primary" />
                                            ...
                                            <div class="row mt-2 mb-2">
                                                ...
                                                <div class="col-8">
                                                    <select class="form-control form-control-sm border border-primary text-black" id="marital_status">
                                            ...
                                            <div class="row mt-2 mb-2">
                                                ...
                                                <div class="col-8">
                                                    <select class="form-control form-control-sm border border-primary" id="gender">
                                                        <option>Male</option>
                                            ...
                                            <div class="row mt-2 mb-2">
                                                ...
                                                <div class="col-8">
                                                    <div class="form-group">
                                                            <input class="form-control form-control-sm border border-primary" type="date" value="2011-08-19" id="birth_date">
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="row mt-2 mb-2">
                                                ...
                                                <div class="col-8">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="text" id="mobile_number" class="form-control form-control-sm border border-primary"/>
                                                    </div>
                                                </div>
                                            </div>
                                        ...
                                        <div class="row mt-2 mb-2">
                                            ...
                                            <div class="col-8">
                                                        <input type="text" id="sin" class="form-control form-control-sm border border-primary" />
                                            </div>
                                        </div>
                                        <div class="row mt-2 mb-2">
                                            <div class="col-4">
                                            ...
                                            <div class="col-8">
                                                        <input type="text" id="driver_license" class="form-control form-control-sm border border-primary" />
                                                </div>
                                            </div>
                                        <div class="row mt-2 mb-2">
                                            <div class="col-4">
                                            ...
                                            <div class="col-8">
                                                        <input class="form-control form-control-sm border border-primary" type="text" id="language">
                                            </div>
                                        </div>
                                    </div>

                                    <div class="col-4">
                                        <span class="font-size-h4 text-dark">Employment Info</span> <i class="icon-2x la la-pen font-size-h1 text-primary"></i>
                                        <hr class="hr border-2 border-bottom-dark" />
                                        <div class="row mt-2 mb-2">
                                            <div class="col-6">
                                                <span class="text-left font-weight-bold text-black">
                                            ...
                                            <div class="col-6">
                                                <select class="form-control form-control-sm border border-primary" id="employee_type">
                                                    <option>Full Time</option>
                                                    <option>Part Time</option>
                                                    <option>Umemployed</option>
                                                    <option>Pension</option>
                                                    <option>Self-Employed</option>
                                                    <option>Umemployment Insurance</option>
                                                    <option>Government Income</option>
                                                    <option>Child Tax Benifits</option>
                                                    <option>Care Giver</option>
                                                    <option>Disablility</option>
                                        ...
                                        <div class="row mt-2 mb-2">
                                            ...
                                            <div class="col-6">
                                                <input type="text" id="employee_name" class="form-control form-control-sm border border-primary" />
                                        ...
                                        <div class="row mt-2 mb-2">
                                            ...
                                            <div class="col-6">
                                                <input type="text" id="pay_amount" class="form-control form-control-sm border border-primary" />
                                        ...
                                        <div class="row mt-2 mb-2">
                                            <div class="col-6">
                                                <span class="text-left font-weight-bold text-black">
                                                    Paycheck<br />Frequently:
                                                </span>
                                            </div>
                                            <div class="col-6">
                                                <select class="form-control form-control-sm border border-primary" id="employee_type">
                                                    <option>Bi-weeekly</option>
                                        ...
                                        <div class="row mt-2 mb-2">
                                            ...
                                            <div class="col-6">
                                                <input type="text" id="job_title" class="form-control form-control-sm border border-primary" />
                                        ...
                                        <div class="row mt-2 mb-2">
                                            ...
                                            <div class="col-6">
                                                <input class="form-control form-control-sm" type="date" value="2011-08-19" id="next_pay_date">
                                            </div>
                                        ...
                                        <div class="row mt-2 mb-2">
                                            ...
                                            <div class="col-6">
                                                <input type="text" id="year_employer" class="form-control form-control-sm border border-primary" />
                                        ...
                                        <div class="row mt-2 mb-2">
                                            ...
                                            <div class="col-6">
                                                <input type="text" id="work_phone" class="form-control form-control-sm border border-primary" />
                                        ...
                                        <div class="row mt-2 mb-2">
                                            ...
                                            <div class="col-6">
                                                <input type="text" id="supervisor" class="form-control form-control-sm border border-primary" />
                                    ...
                                    <div class="col-4">
                                        <span class="font-size-h4 text-dark"> Household Finances</span> <i class="icon-2x la la-pen font-size-h1 text-primary"></i>
                                        <hr class="hr border-2 border-bottom-dark" />
                                        <div class="row mt-2 mb-2">
                                            <div class="col-6">
                                                <span class="text-left font-weight-bold text-black">
                                            ...
                                            <div class="col-6">
                                                <input type="text" id="payment_amount" class="form-control form-control-sm border border-primary" />
                                        ...
                                        <div class="row mt-2 mb-2">
                                            ...
                                            <div class="col-6">
                                                <select class="form-control form-control-sm border border-primary" id="payment_frequency">
                                                    <option>Bi-weeekly</option>
                                                    <option>Weekly</option>
                                                    <option>Monthly</option>
                                                    <option>Semi-monthly</option>
                                        ...
                                        <div class="row mt-2 mb-2">
                                            ...
                                            <div class="col-6">
                                                <input type="text" id="credit_card_exp" class="form-control form-control-sm border border-primary" />
                                        ...
                                        <div class="row mt-2 mb-2">
                                            ...
                                            <div class="col-6">
                                                <input type="text" id="car_expense" class="form-control form-control-sm border border-primary" />
                                        ...
                                        <div class="row mt-2 mb-2">
                                            ...
                                            <div class="col-6">
                                                <select class="form-control form-control-sm border border-primary" id="bankruptcy">
                                                    <option>No</option>
                                                    <option>Yes</option>
                            ...
                            <div class="tab-pane" id="tab_documents" role="tabpanel">
                                ...
                                <table class="table table-separate table-head-custom table-checkable dataTable no-footer dtr-inline font-size-base pl-10" id="kt_datatable" role="grid" aria-describedby="kt_datatable_info" style="width: 980px;">
                                    <thead>
                                        <tr role="row font-weight-bold">
                                            <th class="sorting sorting_asc text-dark" tabindex="0" aria-controls="kt_datatable" rowspan="1" colspan="1" style="width:128px;" aria-sort="ascending" aria-label="Record ID: activate to sort column descending">Type</th>
                                            <th class="sorting" tabindex="0" aria-controls="kt_datatable" rowspan="1" colspan="1" style="width: 154px;" aria-label="Order ID: activate to sort column ascending">Updated</th>
                                            <th class="sorting" tabindex="0" aria-controls="kt_datatable" rowspan="1" colspan="1" style="width: 30px;" aria-label="Routing: activate to sort column ascending">Number</th>
                                            <th class="sorting" tabindex="0" aria-controls="kt_datatable" rowspan="1" colspan="1" style="width: 30px;" aria-label="Ship City: activate to sort column ascending">Related Files</th>
                                            <th class="sorting_disabled" rowspan="1" colspan="1" style="width: 30px;" aria-label="Actions"></th>
                                        </tr>
                                    </thead>
                                    ...
                                    <tbody class="font-size-lg">
                                        ...
                                        <tr class="odd">
                                            <td class="dtr-control sorting_1" tabindex="0">Loan Agreement</td>
                                            <td>01/01/2023 00:00:00</td>
                                            <td>2</td>
                                            <td>4-loan-agreement.pdf</td>
                                            <td nowrap="">
                                                <div class="dropdown dropdown-inline">
                                                    <i class="con-xl la la-trash font-size-h1 text-dar"></i>

                                                    <a data-toggle="modal" data-target=" #editDocumentType"><i class="con-xl la la-pen font-size-h1 text-dar"></i></a>
                                                    <i class="con-xl la la-file font-size-h1 text-dar"></i> </a>
                                            </td>
                                        </tr>
                                        <tr class="even">
                                            <td class="dtr-control sorting_1" tabindex="0">Loan Agreement</td>
                                            ...
                                            <td nowrap="">
                                                <div class="dropdown dropdown-inline">
                                                    <a data-toggle="modal" data-target=" #exampleModal"> <i class="con-xl la la-trash font-size-h1 text-dar"></i>
                                                    </a>
                                                    <a data-toggle="modal" data-target=" #editDocumentType"><i class="con-xl la la-pen font-size-h1 text-dar"></i></a>
                                                    <i class="con-xl la la-file font-size-h1 text-dar"></i> </a>
                                            </td>
                            ...
                            <div class="tab-pane" id="tab_bank_details" role="tabpanel">
                                <div class="col-sm-8">
                                    <div class="col-sm-8 pt-10">
                                        <button type="button" data-toggle="modal" data-target="#" class="btn btn-success">+ New Bank Account</button>
                                    </div>
                                    <table class="table table-separate table-head-custom table-checkable dataTable no-footer dtr-inline font-size-base" id="kt_datatable" role="grid" aria-describedby="kt_datatable_info" style="width: 700px;">
                                        <thead>
                                            <tr role="row">
                                                ...
                                                <th class="sorting" tabindex="0" aria-controls="kt_datatable" rowspan="1" colspan="1" style="width: 25px;" aria-label="Order ID: activate to sort column ascending">Account Number</th>
                                                <th class="sorting" tabindex="0" aria-controls="kt_datatable" rowspan="1" colspan="1" style="width: 25px;" aria-label="Routing: activate to sort column ascending">Routing</th>
                                                <th class="sorting" tabindex="0" aria-controls="kt_datatable" rowspan="1" colspan="1" style="width: 30px;" aria-label="Ship City: activate to sort column ascending">Institution Number</th>
                                                <th class="sorting" tabindex="0" aria-controls="kt_datatable" rowspan="1" colspan="1" style="width: 30px;" aria-label="Ship Address: activate to sort column ascending">Account Holder Name</th>
                                                <th class="sorting_disabled" rowspan="1" colspan="1" style="width: 30px;" aria-label="Actions">Actions</th>
                                            </tr>
                                        </thead>
                                        ...
                                        <tbody class="font-size-lg">
                                            ...
                                            <tr class="odd">
                                                ...
                                                <td nowrap="">
                                                    <div class="dropdown dropdown-inline">
                                                        <a data-toggle="modal" data-target=" #exampleModal"> <i class="con-xl la la-pen font-size-h1 text-dar"></i>
                                                        </a>
                                                        <i class="con-xl la la-bank font-size-h1 text-dar"></i>
                                                        <i class="con-xl la la-trash font-size-h1 text-dar"></i> </a>
                                                </td>
                                            </tr>
                                            <tr class="even">
                                                            ...
                                                            <div class="modal-dialog modal-lg" role="document">
                                                                <div class="modal-content">
                                                                    ...
                                                                    <div class="modal-footer">
                                                                        ...
                                                                        <button type="button" class="btn btn-primary font-weight-bold btn-lg btn-block">Submit</button>
                                                                    </div>
                                                                </div>
                                                            </div>
                                                        </div>
                            ...
                            <div class="tab-pane" id="tab_application_detail" role="tabpanel">
                                <div class="col-sm-8">
                                    <table class="table table-separate table-head-custom table-checkable dataTable no-footer dtr-inline font-size-base" id="kt_datatable" role="grid" aria-describedby="kt_datatable_info" style="width: 980px;">
                                        <thead>
                                            <tr role="row">
                                                <th class="sorting sorting_asc" tabindex="0" aria-controls="kt_datatable" rowspan="1" colspan="1" style="width: 17px;" aria-sort="ascending" aria-label="ID: activate to sort column descending">ID</th>
                                                <th class="sorting" tabindex="0" aria-controls="kt_datatable" rowspan="1" colspan="1" style="width: 25px;" aria-label="Amount: activate to sort column ascending">Amount</th>
                                                <th class="sorting" tabindex="0" aria-controls="kt_datatable" rowspan="1" colspan="1" style="width: 25px;" aria-label="Applied On: activate to sort column ascending">Applied On</th>
                                                <th class="sorting" tabindex="0" aria-controls="kt_datatable" rowspan="1" colspan="1" style="width: 30px;" aria-label="Product: activate to sort column ascending">Product</th>
                                                <th class="sorting" tabindex="0" aria-controls="kt_datatable" rowspan="1" colspan="1" style="width: 30px;" aria-label="Current Status: activate to sort column ascending">Current Status</th>
                                                <th class="sorting_disabled" rowspan="1" colspan="1" style="width: 30px;" aria-label="Actions">Actions</th>
                                            </tr>
                                        </thead>
                                        <tr class="odd">
                                            <td class="dtr-control sorting_1" tabindex="0">5</td>
                                            <td>$500</td>
                                            <td>09/15/2023 00:00:00</td>
                                            <td>Flat Intrest Bi-weekly</td>
                                            <td>Expired</td>
                                            <td nowrap="">
                                                <div class="dropdown dropdown-inline">
                                                    <a data-toggle="modal" data-target=" #exampleModal"> <i class="con-xl la la-eye  font-size-h1 text-dar"></i>
                                                    </a>
                                                </div>
                                        ...
                                        <tr class="odd">
                                            <td class="dtr-control sorting_1" tabindex="0">6</td>
                                            <td>$500</td>
                                            <td>05/15/2023 00:00:00</td>
                                            <td>Payday 6-30 days</td>
                                            <td>Expired</td>
                                            <td nowrap="">
                                                <div class="dropdown dropdown-inline">
                                                    <a data-toggle="modal" data-target=" #exampleModal"> <i class="con-xl la la-eye  font-size-h1 text-dar"></i>
                            ...
                            <div class="modal fade" id="newNoteModel" tabindex="-1" aria-labelledby="newNoteModelLabel" aria-hidden="true" style="display: none;">
                                <div class="modal-dialog modal-lg" role="document">
                                    <div class="modal-content">
                                        <div class="modal-header">
                            ...
                            <div class="modal fade" id="editDocumentType" tabindex="-1" aria-labelledby="newNoteModelLabel" aria-hidden="true" style="display: none;">
                                <div class="modal-dialog modal-lg" role="document">
                                    <div class="modal-content">
                                        <div class="modal-header">
                                        ...
                                        <div class="modal-body">
                                            <div class="row">
                                                <div class="col">
                                                    Choose Document File Type
                                                    <br />
                                                    <select class="form-control" id="LoanAgrreement">
                            ...
                            <div class="tab-pane" id="tab_notes_detail" role="tabpanel">
                                <div class="col-sm-8">
                                    <div class="col-sm-8 pt-10">
                                        <button type="button" data-toggle="modal" data-target=" #newNoteModel" class="btn btn-success">+ New Note</button>
                                    </div>
                                    <div class="row pt-9">
                                    ...
                                    <table class="table table-separate table-head-custom table-checkable dataTable no-footer dtr-inline font-size-base" id="kt_datatable" role="grid" aria-describedby="kt_datatable_info" style="width: 700px;">
                                        <thead>
                                            <tr role="row">
                                                ...
                                                <th class="sorting" tabindex="0" aria-controls="kt_datatable" rowspan="1" colspan="1" style="width: 25px;" aria-label="Date: activate to sort column ascending">Date</th>
                                                <th class="sorting" tabindex="0" aria-controls="kt_datatable" rowspan="1" colspan="1" style="width: 25px;" aria-label="Note: activate to sort column ascending">Note</th>
                                                <th class="sorting" tabindex="0" aria-controls="kt_datatable" rowspan="1" colspan="1" style="width: 30px;" aria-label="Action: activate to sort column ascending">Action</th>
                                            </tr>
                                        </thead>
                                        <tr class="odd">
                                            ...
                                            <td>09/15/2023</td>
                                            <td>1817.86</td>
                                            <td><a href="./show_notes.php" class="btn btn-primary text-white">Show</a>
                                                <a href="./edit_note.php" class="btn btn-primary text-white">Edit</a>
                                            </td>
                                        </tr>
                                    </table>
                                    <div class="row">
                            ...
                            <div class="tab-pane" id="example_code_1_js" role="tabpanel">
                                ...
                                <div class="card-body">
                                    <div id="kt_datatable_wrapper" class="dataTables_wrapper dt-bootstrap4">
                                        <div class="row">
                                            <div class="col-sm-12">
                                                <table class="table table-bordered table-hover table-checkable dataTable dtr-inline" id="kt_datatable" role="grid" aria-describedby="kt_datatable_info" style="width: 1235px;">
                                                    <thead>
                                                        <tr role="row">
                                                            <th class="sorting sorting_asc" tabindex="0" aria-controls="kt_datatable" rowspan="1" colspan="1" style="width: 72px;" aria-sort="ascending" aria-label="Loan Id: activate to sort column descending">Loan ID</th>
                                                            <th class="sorting" tabindex="0" aria-controls="kt_datatable" rowspan="1" colspan="1" style="width: 70px;" aria-label="Product: activate to sort column ascending">Product</th>
                                                            <th class="sorting" tabindex="0" aria-controls="kt_datatable" rowspan="1" colspan="1" style="width: 127px;" aria-label="Amount: activate to sort column ascending">Amount</th>
                                                            <th class="sorting" tabindex="0" aria-controls="kt_datatable" rowspan="1" colspan="1" style="width: 166px;" aria-label="Principal: activate to sort column ascending">Principal</th>
                                                            <th class="sorting" tabindex="0" aria-controls="kt_datatable" rowspan="1" colspan="1" style="width: 121px;" aria-label="Interest: activate to sort column ascending">Interest</th>
                                                            <th class="sorting" tabindex="0" aria-controls="kt_datatable" rowspan="1" colspan="1" style="width: 72px;" aria-label="Fees: activate to sort column ascending">Fees</th>
                                                            <th class="sorting" tabindex="0" aria-controls="kt_datatable" rowspan="1" colspan="1" style="width: 67px;" aria-label="Term: activate to sort column ascending">Term</th>
                                                            <th class="sorting" tabindex="0" aria-controls="kt_datatable" rowspan="1" colspan="1" style="width: 45px;" aria-label="Created On: activate to sort column ascending">Created On</th>
                                                            <th class="sorting_disabled" rowspan="1" colspan="1" style="width: 116px;" aria-label="Assigned To">Assigned To</th>
                                                            <th class="sorting_disabled" rowspan="1" colspan="1" style="width: 116px;" aria-label="Assigned To">Status</th>
                                                            <th class="sorting_disabled" rowspan="1" colspan="1" style="width: 116px;" aria-label="Assigned To">Action</th>
                                                        </tr>
                                                    </thead>
                                                    ...
                                                    <tbody>
                                                        <tr class="odd">
                                                            ...
                                                            <td>168.9</td>
                                                            <td>0</td>
                                                            <td><span class="sorting_1 dtr-control">45</span></td>
                                                            <td><span class="sorting_1 dtr-control"></span><span class="sorting_1 dtr-control">4 Month Ago</span>
                                                            <td><span class="sorting_1 dtr-control">LMS Admin</span></td>
                                                            </td>
                                                            <td>Paid-off</td>
                                                            <td nowrap="">
                                                                <div class="dropdown dropdown-inline">
                                                                    <a href="./customer_info.php"> <i class="con-xl la la-eye  font-size-h1 text-dar"></i>
                                                                    </a>
                                                                </div>
                                                        ...
                                                        <tr class="even">
                                                            ...
                                                            <td>1670</td>
                                                            <td>72</td>
                                                            <td><span class="sorting_1 dtr-control">4</span></td>
                                                            <td><span class="sorting_1 dtr-control"></span><span class="sorting_1 dtr-control">2 months ago</span>
                                                            <td><span class="sorting_1 dtr-control">LMS Admin</span></td>
                                                            </td>
                                                            <td>Paid-off </td>
                                                            <td nowrap="">
                                        ...
                                        <div class="row">
                                            <div class="col-sm-12 col-md-5">
                                                <div class="dataTables_info" id="kt_datatable_info" role="status" aria-live="polite">Showing 1 to 10 of 350 entries</div>
                                            </div>
                                            <div class="col-sm-12 col-md-7 dataTables_pager">
                                                <div class="dataTables_length" id="kt_datatable_length"></div>
                                                <div class="dataTables_paginate paging_simple_numbers" id="kt_datatable_paginate">
                                                    <ul class="pagination">
                                                        ...
                                                        <li class="paginate_button page-item disabled" id="kt_datatable_ellipsis"><a href="#" aria-controls="kt_datatable" data-dt-idx="6" tabindex="0" class="page-link">…</a></li>
                                                        <li class="paginate_button page-item "><a href="#" aria-controls="kt_datatable" data-dt-idx="7" tabindex="0" class="page-link">35</a></li>
                                                        <li class="paginate_button page-item next" id="kt_datatable_next"><a href="#" aria-controls="kt_datatable" data-dt-idx="8" tabindex="0" class="page-link"><i class="ki ki-arrow-next"></i></a></li>
                                                    </ul>
                                                </div>
                                            </div>
                                        </div>
