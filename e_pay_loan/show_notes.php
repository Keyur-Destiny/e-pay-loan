                ...
                <div class="content  d-flex flex-column flex-column-fluid" id="kt_content">
                    ...
                    <div class="card card-custom card-fit card-border">
                        <div class="card-header">
                            <div class="card-title font-size-h1">
                        ...
                        <div class="card-body pt-2">
                            ...
                            <div class="mt-5">
                                <p class="font-size-base text-muted">
                                    Date created: Sep 14, 2023 - 8:28 AM (Gaurang Patel)

                                </p>
                                <p class="font-size-base text-muted">
                                    Date updated: Sep 14, 2023 - 8:28 AM (Gaurang Patel)

                                </p>
                                <span class="font-size-h5 mt-5">
