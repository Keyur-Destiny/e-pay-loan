                                                ...
                                                <div class="card card-custom card-stretch gutter-b">
                                                    ...
                                                    <div class="card-body d-flex">
                                                        <div class="d-flex flex-column">
                                                            <div class="row">
                                                                <div class="col-10">
                                                                    <a href="#" class="card-title font-weight-bolder text-muted font-size-18 mb-2 pl-5 pr-5 text-hover-primary">Scheduled Payments</a>
                                                                </div>
                                                                <div class="col-2">
                                                                <span class="icon-3x la la-stopwatch text-muted" />
                                            ...
                                            <div class="row">
                                                <div class="col-sm-12">
                                                    <table class="table table-separate table-head-custom table-checkable dataTable no-footer dtr-inline collapsed" id="kt_datatable" role="grid" aria-describedby="kt_datatable_info" style="width: 100%;">
                                                        <thead>
                                                            <tr role="row">
                                                                <th class="sorting sorting_asc" tabindex="0" aria-controls="kt_datatable" rowspan="1" colspan="1" style="width: 30%;" aria-sort="ascending" aria-label="Record ID: activate to sort column descending">Payment Scheduled Date</th>
                                                                <th class="sorting" tabindex="0" aria-controls="kt_datatable" rowspan="1" colspan="1" style="width: 20%;" aria-label="Order ID: activate to sort column ascending">Payment Amount</th>
                                                                <th class="sorting" tabindex="0" aria-controls="kt_datatable" rowspan="1" colspan="1" style="width: 10%;" aria-label="Country: activate to sort column ascending">Capital</th>
                                                                <th class="sorting" tabindex="0" aria-controls="kt_datatable" rowspan="1" colspan="1" style="width: 10%;" aria-label="Ship City: activate to sort column ascending">Interest</th>
                                                                <th class="sorting" tabindex="0" aria-controls="kt_datatable" rowspan="1" colspan="1" style="width: 10%;" aria-label="Ship City: activate to sort column ascending">Fees</th>
                                                                <th class="sorting" tabindex="0" aria-controls="kt_datatable" rowspan="1" colspan="1" style="width: 10%;" aria-label="Ship Address: activate to sort column ascending">Status</th>
                                                                <th class="sorting" tabindex="0" aria-controls="kt_datatable" rowspan="1" colspan="1" style="width: 10%;" aria-label="Ship Address: activate to sort column ascending">LID</th>
                                                            </tr>
                                                        </thead>
                                                        <tbody>
                                                            <tr>
