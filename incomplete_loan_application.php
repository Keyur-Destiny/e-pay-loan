                            ...
                            <form class="form">
                                <div class="card-body">
                                    <div class="form-group row">
                                        <label class="col-2 font-size-h6 col-form-label">Days</label>
                                        <div class="col-9">
                                           <input type="text" class="form-control form-control-lg" placeholder="Days"/>
                                        </div>
                                        <div class="col-1"></div>
                                    </div>
                                    <div class="form-group row">
                                        <label class="col-2 font-size-h6 col-form-label">Campeign Status</label>
                                        <div class="col-9">
                                        <select class="form-control font-size-h6">
                                                        <option class="font-size-h6">Active</option>
                                                        <option class="font-size-h6">Disabled</option>
                                                    </select>
                                        </div>
                                        <div class="col-1"></div>
                                    </div>
                                    <div class="form-group row">
                                        <label class="col-2 font-size-h6 col-form-label">Subject</label>
                                        <div class="col-9">
                                           <input type="text" class="form-control form-control-lg" placeholder="App Notification"/>
                                        </div>
                                        <div class="col-1"></div>
                                    </div>
                                    <div class="form-group row mt-5">
                                        <label class="col-2 font-size-h6 col-form-label"></label>
                                        <div class="col-8">
                                        </div>
                                        <div class="col-2">
