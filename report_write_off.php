                                        ...
                                        <div class="card card-custom">
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-3">
                                                        ...
                                                        <div class="input-group date" data-provide="datepicker">
                                                            <span class="font-size-base text-dark mt-2">From</span>
                                                            <input type="text" class="form-control ml-2" placeholder="Select date">
                                                    ...
                                                    <div class="col-3">
                                                        ...
                                                        <div class="input-group date" data-provide="datepicker">
                                                            <span class="font-size-base text-dark mt-2">To</span>
                                                    ...
                                                    <div class="col-2">
                                                        ...
                                                        <div class="input-group date">
                                                            <a href="#assignToPop" data-toggle="modal" class="btn btn-primary btn-lg font-weight-bold font-size-base text-muted">
                                                                Submit
                                                            </a>
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="col-2">
                                                        ...
                                                        <div class="input-group date">
                                                            <a href="#" class="btn btn-light-primary btn-lg font-weight-bold font-size-base text-muted">
                                                                Export
                                                            </a>
                                                        </div>
                                                    </div>
                                            ...
                                            <div class="row">
                                                <div class="col-sm-12">
                                                    <table class="table table-separate table-head-custom table-checkable dataTable no-footer dtr-inline collapsed" id="kt_datatable" role="grid" aria-describedby="kt_datatable_info" style="width: 100%;">
                                                        <thead>
                                                            <tr role="row">
                                                                <th class="sorting sorting_asc" tabindex="0" aria-controls="kt_datatable" rowspan="1" colspan="1" style="width: 7%;" aria-sort="ascending" aria-label="Record ID: activate to sort column descending"></th>
                                                                <th class="sorting" tabindex="0" aria-controls="kt_datatable" rowspan="1" colspan="1" style="width: 7%;" aria-label="Order ID: activate to sort column ascending">Loan ID</th>
                                                                <th class="sorting" tabindex="0" aria-controls="kt_datatable" rowspan="1" colspan="1" style="width: 7%;" aria-label="Country: activate to sort column ascending">Cust ID</th>
                                                                <th class="sorting" tabindex="0" aria-controls="kt_datatable" rowspan="1" colspan="1" style="width: 7%;" aria-label="Ship City: activate to sort column ascending">First Name</th>
                                                                <th class="sorting" tabindex="0" aria-controls="kt_datatable" rowspan="1" colspan="1" style="width: 7%;" aria-label="Ship City: activate to sort column ascending">Last Name</th>
                                                                <th class="sorting" tabindex="0" aria-controls="kt_datatable" rowspan="1" colspan="1" style="width: 7%;" aria-label="Ship Address: activate to sort column ascending">Adress</th>
                                                                <th class="sorting" tabindex="0" aria-controls="kt_datatable" rowspan="1" colspan="1" style="width: 7%;" aria-label="Ship Address: activate to sort column ascending">City</th>
                                                                <th class="sorting" tabindex="0" aria-controls="kt_datatable" rowspan="1" colspan="1" style="width: 7%;" aria-label="Ship Address: activate to sort column ascending">Province</th>
                                                                <th class="sorting" tabindex="0" aria-controls="kt_datatable" rowspan="1" colspan="1" style="width: 7%;" aria-label="Ship Address: activate to sort column ascending">Postal Code</th>
                                                                <th class="sorting" tabindex="0" aria-controls="kt_datatable" rowspan="1" colspan="1" style="width: 7%;" aria-label="Ship Address: activate to sort column ascending">Home Phone</th>
                                                                <th class="sorting" tabindex="0" aria-controls="kt_datatable" rowspan="1" colspan="1" style="width: 7%;" aria-label="Ship Address: activate to sort column ascending">Other Phone</th>
                                                                <th class="sorting" tabindex="0" aria-controls="kt_datatable" rowspan="1" colspan="1" style="width: 7%;" aria-label="Ship Address: activate to sort column ascending">DOB</th>
                                                                <th class="sorting" tabindex="0" aria-controls="kt_datatable" rowspan="1" colspan="1" style="width: 7%;" aria-label="Ship Address: activate to sort column ascending">SIN</th>
                                                                <th class="sorting" tabindex="0" aria-controls="kt_datatable" rowspan="1" colspan="1" style="width: 7%;" aria-label="Ship Address: activate to sort column ascending">Loan Start Date</th>
                                                            </tr>
                                                        </thead>
                                                        <tbody>
                                                            <tr>
                                            ...
                                            <div class="row">
                                                <div class="col-sm-12 col-md-8">
                                                    <div class="dataTables_info font-weight-bold" id="kt_datatable1_info" role="status" aria-live="polite">Showing 1 to 10 of 50 entries</div>
                                                </div>
                                                <div class="col-sm-12 col-md-3 dataTables_pager">
