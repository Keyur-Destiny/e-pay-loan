                            ...
                            <form class="form">
                                <div class="card-body">
                                    <div class="form-group row">
                                        <label class="col-2 font-size-h6 col-form-label">Ticket Subject</label>
                                        <div class="col-9">
                                            <input type="text" class="form-control form-control-lg" placeholder="Ticket Subject" />
                                        </div>
                                        <div class="col-1"></div>
                                    </div>
                                    <div class="form-group row">
                                        <label class="col-2 font-size-h6 col-form-label">Ticket Severity</label>
                                        <div class="col-9">
                                            <select class="form-control font-size-h6">
                                                <option class="font-size-h6">LOW</option>
                                                <option class="font-size-h6">MEDIUM</option>
                                                <option class="font-size-h6">HIGH</option>
                                                <option class="font-size-h6">URGENT</option>
                                            </select>
                                        </div>
                                        <div class="col-1"></div>
                                    </div>
                                    <div class="form-group row">
                                        <label class="col-2 font-size-h6 col-form-label">Assign To</label>
                                        <div class="col-9">
                                            <select class="form-control font-size-h6">
                                                <option class="font-size-h6">Gaurang Patel - gaurang@gmail.com</option>
                                                <option class="font-size-h6">LMS Admin - admin@appliedlms.com</option>
                                                <option class="font-size-h6">Doug Tanner - doug@applied-ai.ca</option>
                                                <option class="font-size-h6">Emma Chille - emma@applied-ai.ca</option>
                                            </select>
                                        </div>
                                        <div class="col-1"></div>
                                    </div>
                                    <div class="form-group row">
                                        <label class="col-2 font-size-h6 col-form-label">Ticket For Loan Application</label>
                                        <div class="col-9">
                                        <select class="form-control font-size-h6">
                                        </select>
                                        </div>
                                    ...
                                    <div class="form-group row">
                                        <label class="col-2 font-size-h6 col-form-label">Ticket For Loan</label>
                                        <div class="col-9">
                                        <select class="form-control font-size-h6">
                                        </select>
                                        </div>
                                    ...
                                    <div class="form-group row mt-7">
                                        <label class="col-2 font-size-h5 col-form-label">
