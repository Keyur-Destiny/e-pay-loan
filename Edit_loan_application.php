                                ...
                                <form class="form">
                                    <div class="card-body">
                                        <div>
                                            <div class="form-group row">
                                                ...
                                                <div class="col-lg-8">
                                                    <select class="form-control font-size-h6">
                                                        <option class="font-size-h6">Flat Interest Bi-Weekly</option>
                                                        <option class="font-size-h6">Flat Interest Monthly</option>
                                                        <option class="font-size-h6">Payday</option>
                                                        <option class="font-size-h6">PAYDAY TEST2</option>
                                                    </select>
                                                </div>
                                            </div>
                                            <div class="form-group row">
                                                <label class="col-lg-3 font-size-h5 col-form-label">Start Date</label>
                                                <div class="col-lg-8">
                                            ...
                                            <div class="form-group row">
                                                <label class="col-lg-3 font-size-h5 col-form-label">Amount</label>
                                                <div class="col-lg-8">
                                                    <input class="form-control font-size-h6" type="number">

                                                </div>
                                            </div>
                                             <div class="form-group row">
                                                <label class="col-lg-3 font-size-h5 col-form-label">Select Loan Term: day</label>
                                                <div class="col-lg-8">
                                                <select class="form-control font-size-h6">
                                                        <option class="font-size-h6">6</option>
                                                        <option class="font-size-h6">10</option>
                                                        <option class="font-size-h6">15</option>
                                                        <option class="font-size-h6">20</option>
                                                    </select>
