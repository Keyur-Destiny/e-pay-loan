                                ...
                                <div class="tab-content p-0" id="myTabContent">
                                    <div class="tab-pane fade show active" id="pdv" role="tabpanel" aria-labelledby="home-tab">
                                        ...
                                        <div class="row mt-13">
                                            ...
                                            <div class="col-2">
                                                <a href="#" class="btn btn-light-primary px-4 font-weight-bold font-size-base text-muted text-right">
                                                    Export
                                                </a>
                                            </div>
                                        ...
                                        <div class="row mt-10">
                                            <div class="col-sm-12 col-md-8">
                                                <div class="text-muted row" id="kt_datatable_length">
                                        ...
                                        <div class="row">
                                            <div class="col-sm-12">
                                                <table class="table table-separate table-head-custom table-checkable dataTable no-footer dtr-inline collapsed" id="kt_datatable" role="grid" aria-describedby="kt_datatable_info" style="width: 926px;">
                                                    <thead>
                                                        <tr role="row">
                                                            <th class="sorting sorting_asc" tabindex="0" aria-controls="kt_datatable" rowspan="1" colspan="1" style="width: 85px;" aria-sort="ascending" aria-label="Record ID: activate to sort column descending">ID</th>
                                                            <th class="sorting" tabindex="0" aria-controls="kt_datatable" rowspan="1" colspan="1" style="width: 120px;" aria-label="Order ID: activate to sort column ascending">Full Name</th>
                                                            <th class="sorting" tabindex="0" aria-controls="kt_datatable" rowspan="1" colspan="1" style="width: 120px;" aria-label="Country: activate to sort column ascending">Email</th>
                                                            ...
                                                            <th class="sorting" tabindex="0" aria-controls="kt_datatable" rowspan="1" colspan="1" style="width: 120px;" aria-label="Ship Address: activate to sort column ascending">Main Phone #</th>
                                                            <th class="sorting" tabindex="0" aria-controls="kt_datatable" rowspan="1" colspan="1" style="width: 120px;" aria-label="Company Agent: activate to sort column ascending">Date Created</th>
                                                            <th class="sorting" tabindex="0" aria-controls="kt_datatable" rowspan="1" colspan="1" style="width: 147px;" aria-label="Company Name: activate to sort column ascending">Action</th>
                                                        </tr>
                                                    </thead>
                                                    <tbody>
                                                        <tr>
                                                            ...
                                                            <td>
                                                                <a href="./user_page.php"><span class="con-xs la la-eye  font-size-h1 text-dar" /></a>
                                                                <a href="./Edit_customer.php"><span class="con-xs la la-pen  font-size-h1 text-dar" /></a>
                                                                <a href="./user_page.php"><span class="con-xs la la-flag  font-size-h1 text-dar" /></a>
                                                                <span class="con-xs la la-trash  font-size-h1 text-dar" />
                                                                <a id="dropdownMenuButton" data-toggle="dropdown" aria-expanded="true">
                                                                    <span class="ki ki-more-ver icon-xl text-muted" />
                                                                </a>
