                                ...
                                <div class="card card-custom bg-white">
                                    <div class="card-header ribbon ribbon-right">
                                        <div class="ribbon-target bg-primary" style="top: 10px; right: -2px;">
                                            <a data-toggle="modal" data-target="#editLoanApplication">EDIT</a>
                                        </div>
                                        <h3 class="card-title">
                                            Default
                                        </h3>
                                        ...
                                        <div class="row">
                                            <div class="col-4">
                                                <div class="d-flex justify-content-center">
                                                    <img src="assets/media/svg/icons/Shopping/Dollar.svg" class="text-center" />
                                                </div>
                                                <br />
                                                ...
                                                <div class="d-flex justify-content-lg-between">
                                                    <div>
                                                        <span>
                                                            Requested <br /> Amount <br /> $1500
                                                        </span>
                                                    </div>
                                                    <div class="mt-5">

                                                        <span>
                                                            Total Amount <br /> $1500
                                                        </span>
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="col-4">
                                                ...
                                                <div>
                                                    <h6>
                                                        Payday 6-30 days / Interest Rate: 63% Term : 10 day
                                                        </h5>
                                                </div>
                                            </div>
                                            <div class="col-xl-2">
                                            ...
                                            <div class="col-xl-2">
                                                ...
                                                <div class="d-flex justify-content-lg-between">
                                                    ...
                                                    <div>
                                                        <a data-toggle="modal" data-target="#exampleProfile"><span class="flaticon2-edit ml-2" /></a>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="row mt-5">
                                            <div class="col-2">
                                                ...
                                                <div class="text-center">
                                                    <span class="font-size-sm-3 font-weight-bold">
                                                        Send IBV Request
                                                    </span>
                                            ...
                                            <div class="col-3">
                                                <div class="d-flex justify-content-center">
                                                    <img src="assets/media/svg/icons/General/circle_multiple.svg" height="20" width="20" />
                                            ...
                                            <div class="col-2">
                                                ...
                                                <div class="text-center">
                                                    ...
                                                    <span class="font-size-sm-2 font-weight-bold">
                                                        02/02/2014
                                                    </span>
                                            ...
                                            <div class="col-2">
                                                <div class="d-flex justify-content-center">
                                                    <img src="assets/media/svg/icons/General/paper.svg" height="20" width="20" />
                                            ...
                                            <div class="col-3">
                                                <div class="d-flex justify-content-center">
                                                    <img src="assets/media/svg/icons/General/bullish.svg" height="20" width="20" />
                    ...
                    <div>
                        <div class="example-code">
                            <ul class="example-nav nav nav-tabs nav-tabs-line nav-tabs-line-2x font-size-h6 nav-tabs-primary" id="myTab" role="tablist">
                                <li class="nav-item">
                                    <a class="nav-link active text-center" data-toggle="tab" href="#example_code_1_html">Customer<br /> Info</a>
                                </li>
                                <li class="nav-item text-center">
                                    <a class="nav-link" data-toggle="tab" href="#example_code_1_js">Credit <br />History</a>
                                </li>
                                <li class="nav-item text-center">
