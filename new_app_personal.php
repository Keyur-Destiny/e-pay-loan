                                                ...
                                                <div class="col-xl-8">
                                                    <div class="my-5">
                                                        <div class="form-group column">
                                                            <label class="col-3 font-size-h4 text-muted">Start Date</label>
                                                            <div class="col-10">
                                                        ...
                                                        <div class="form-group column">
                                                            ...
                                                            <div class="col-10">
                                                                <select class="form-control form-control-solid font-size-h4">
                                                                    ...
                                                                    <option value="AX">Flat Interest Monthly</option>
                                                                    <option value="PD">PayDay</option>
                                                                    <option value="FSM">Flat Interest Semi-Monthly</option>    
                                                                    <option value="PST">PayDay 6-30 Days</option>
                                                                    <option value="FIW">Flat Interest Weekly</option>
                                                                    <option value="PDT">PayDay Test 2</option>
                                                        ...
                                                        <div class="form-group row">
                                                            <div class="col-4"></div>
                                                            <div class="col-10 font-size-h3 pl-7">
                                                            <a href="#" class="btn btn-secondary font-size-h3 mr-2">$100</a>
                                                            <a href="#" class="btn btn-secondary font-size-h3 mr-2">$200</a>
                                                            <a href="#" class="btn btn-secondary font-size-h3 mr-2">$300</a>
                                                            <a href="#" class="btn btn-secondary font-size-h3 mr-2">$500</a>  
                                                            </div>
                                                        </div>
                                                        <div class="form-group row">
                                                             <div class="col-4">
                                                                <label class="font-size-h4 text-muted">2. Loan Amount</label>
                                                             ...
                                                             <div class="col-4">
                                                                <label class="font-size-h4 text-muted">3. Loan Term</label>
                                                                <div class="input-group">
                                                    ...
                                                    <div class="my-5">
                                                        <h2 class=" text-dark font-weight-bold mb-10">Personal Information</h3>
                                                            <div class="separator separator-dashed my-10"></div>

                                                            <div class="form-group row">
                                                                <div class="col-4">
                                                                   <label class="font-size-h4 text-muted">First Name</label>
                                                                   <div class="input-group">
                                                                      
                                                                       <input type="text" class="form-control" placeholder="Mike" aria-label="First Name">
                                                                   </div>
   
                                                                </div>
                                                                <div class="col-4">
                                                                    <label class="font-size-h4 text-muted">Middle Name</label>
                                                                    <div class="input-group">
                                                                ...
                                                                <div class="col-4">
                                                                   <label class="font-size-h4 text-muted">Last Name</label>
                                                                   <div class="input-group">
                                                           ...
                                                           <div class="form-group row">
                                                            <div class="col-4">
                                                               <label class="font-size-h4 text-muted">Phone Number</label>
                                                               <div class="input-group">
                                                                  
                                                                   <input type="text" class="form-control" placeholder="(514)-532-1182" aria-label="Phone Number">
                                                               </div>

                                                            </div>
                                                            <div class="col-4">
                                                                <label class="font-size-h4 text-muted">Email</label>
                                                                <div class="input-group">
                                                                   
                                                                    <input type="text" class="form-control" placeholder="example@gmail.com" aria-label="Email">
                                                                </div>
                                                       ...
                                                       <div class="form-group row">
                                                        <div class="col-4">
                                                        <label class="font-size-h4">Marital Status</label>
                                                        <div class="radio-list font-size-h6">
                                                            <label></label>
                                                            <div class="radio-list">
                                                                <label class="radio font-size-h6">
                                                    ...
                                                    <div class="col-4">
                                                        <label class="font-size-h4">Gender</label>
                                                        <div class="radio-list font-size-h6">
                                                            <label></label>
                                                            <div class="radio-list">
                                                                <label class="radio font-size-h6">
                                                                ...
                                                                <label class="radio font-size-h6">
                                                                    <input type="radio" checked="checked" name="radios2">
                                                                    <span></span>
                                                                    Female
                                                                </label>
                                                                <label class="radio font-size-h6">
                                                    ...
                                                    <div class="form-group row">
                                                        <div class="col-7">
                                                        <label class="font-size-h6">Address</label>
                                                    ...
                                                    <div class="col-5">
                                                        <label class="font-size-h6">How many years in this address</label>
                                                        <div class="input-group">
                                                                   
                                                            <input type="text" class="form-control" placeholder="7" aria-label="Email">
                                                        </div>
                                                    ...
                                                    <div class="form-group row">
                                                        <div class="col-4">
                                                            <label class="font-size-h4 text-muted">Date of Birth</label>
                                                            <div class="input-group">
                                                                <input class="form-control" type="date" value="2011-08-19" id="example-date-input">
                                                            </div>
                                                        </div>
                                                        <div class="col-4">
                                                            <label class="font-size-h4 text-muted">Social Security Number</label>
                                                            <div class="input-group">
                                                                <input class="form-control" type="text" id="security-number">
                                                            </div>
                                                        </div>
                                                        <div class="col-4">
                                                            <label class="font-size-h4 text-muted">Driver's License</label>
                                                            <div class="input-group">
                                                                <input class="form-control" type="text" id="driver-license">
                                                            </div>
                                                        </div>
                                                        </div>
                                                       
                                                    <div class="my-52">
                                                        <h2 class=" text-dark font-weight-bold mb-10">Security:</h2>
                                                        <div class="separator separator-dashed my-10"></div>

                                                       
                                                        <div class="form-group row">
                                                            <div class="col-6">
                                                                <label class="font-size-h4 text-muted">Employment type</label>
                                                                <div class="input-group">
                                                                    <select class="form-control form-control-solid font-size-h5">
                                                            ...
                                                            <div class="col-6">
                                                                <label class="font-size-h4 text-muted">How many years with employer?</label>
                                                                <div class="input-group">
                                                                    <input class="form-control" type="text" id="security-number">
                                                                </div>
                                                            </div>
                                                            ...
                                                            <div class="form-group row">
                                                                <div class="col-6">
                                                                    <label class="font-size-h4 text-muted">Employer Name</label>
                                                                    <div class="input-group">
                                                                        <input class="form-control" type="text" id="employer-name">

                                                                      
                                                                    </div>
                                                                </div>
                                                                <div class="col-6">
                                                                    <label class="font-size-h4 text-muted">Payment Frequency</label>
                                                                    <div class="input-group">
                                                                        <select class="form-control form-control-solid font-size-h5">
                                                                            <option value="MT">Monthly</option>
                                                                            <option value="YL">Yearly</option>
                                                                            <option value="WL">Weekly</option>
                                                                ...
                                                                <div class="form-group row">
                                                                    <div class="col-6">
                                                                        <label class="font-size-h4 text-muted">Job Title</label>
                                                                        <div class="input-group">
                                                                    ...
                                                                    <div class="col-6">
                                                                        <label class="font-size-h4 text-muted">Next Payment Date</label>
                                                                        <div class="input-group">
                                                                            <input class="form-control" type="date" value="2011-08-19" id="payment-date-input">
                                                                    ...
                                                                    <div class="form-group row">
                                                                        <div class="col-6">
                                                                            <label class="font-size-h4 text-muted">Employer Phone</label>
                                                                            <div class="input-group">
                                                                                <input class="form-control" type="text" id="emploer-phone">
        
                                                                              
                                                                            </div>
                                                                        </div>
                                                                        <div class="col-6">
                                                                            <label class="font-size-h4 text-muted">Superviser Name</label>
                                                                            <div class="input-group">
                                                                                <input class="form-control" type="text" id="superviser-name">
                                                                        ...
                                                                        <div class="form-group row">
                                                                            <div class="col-6">
                                                                                <label class="font-size-h4 text-muted">Employer Address</label>
                                                                                <div class="input-group">
                                                                                    <input class="form-control" type="text" id="emploer-add">
            
                                                                                  
                                                                                </div>
                                                                            </div>
                                                                            <div class="col-6">
                                                                                <label class="font-size-h4 text-muted">Payment Amount</label>
                                                                                <div class="input-group">
                                                                                    <input class="form-control" type="text" id="payment_amount">
                                                                            ...
                                                                            <div class="my-5">
                                                                                <h2 class=" text-dark font-weight-bold mb-10">Personal Finance</h3>
                                                                                    <div class="separator separator-dashed my-10"></div>
                        
                                                                                    <div class="form-group row">
                                                                                        <div class="col-6">
                                                                                           <label class="font-size-h4 text-muted">Rent/Mortgage Payment</label>
                                                                                           <div class="input-group">
                                                                                              
                                                                                               <input type="text" class="form-control" placeholder="" aria-label="Mortgage Amount">
                                                                                           </div>
                                                                                   ...
                                                                                   <div class="form-group row">
                                                                                    <div class="col-6">
                                                                                       <label class="font-size-h4 text-muted">Credit Card Monthly Expense</label>
                                                                                       <div class="input-group">
                                                                                    ...
                                                                                    <div class="col-6">
                                                                                        <label class="font-size-h4 text-muted">Car Payment</label>
                                                                                        <div class="input-group">
                                                                                           
                                                                                            <input type="text" class="form-control" placeholder="" aria-label="Car Payment">
                                                                                        </div>
                                                                               ...
                                                                               <div class="form-group row">
                                                                                <div class="col-6">
                                                                                <label class="font-size-h5">Have you ever declared bankruptcy?</label>
                                                                                <div class="radio-list font-size-h6">
                                                                                    <label></label>
                                                                                    <div class="radio-list">
                                                                                        <label class="radio font-size-h6">
                                                                            ...
                                                                            <div class="col-6">
                                                                                <label class="font-size-h6">Are you currently in consumer proposal?</label>
                                                                                <div class="radio-list font-size-h6">
                                                                                    <label></label>
                                                                                    <div class="radio-list">
                                                                                        <label class="radio font-size-h6">
                                                                            ...
                                                                            <div class="form-group row">
                                                                                <input type="submit" value="Submit" class="btn btn-light-primary px-6 font-weight-bold font-size-h3"/>
