                    ...
                    <div class="login-form login-signin">
                        ...
                        <form class="form" novalidate="novalidate" id="kt_login_signin_form">
                            ...
                            <div class="text-center pb-8">
                                <h2 class="font-weight-bolder font-size-h2 font-size-h1-lg">Reset Password
                                    !</h2>
                                <span class="text-muted font-weight-bold font-size-h4">Reset your Password to [TRIAL]
                                    ePay Loan.</span>
                            </div>
                            <!--end::Title-->
                            ...
                            <div class="text-center pt-2">
                                <button id="kt_login_signin_submit"
                                        ...
                                        style="background-color:#eab676;color:white;">Reset
                                </button>
                            </div>
