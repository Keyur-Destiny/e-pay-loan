                ...
                <div class="" id="kt_content">
                    ...
                    <div class="container-fluid dashboard">
                        <div class="example-preview">
                                ...
                                <div class="col-xl-3">
                                    ...
                                    <div class="card card-custom bgi-no-repeat bgi-size-cover gutter-b" style="height: 370px; background-color:#5969ca;">
                                        ...
                                        <div class="card-body d-flex flex-column">
                                            ...
                                            <br />
                                            <span class="text-center font-size-h2 text-white"><a href="./user_page.php">Mike May</a></span>
                                    ...
                                    <div class="card card-custom bg-white">
                                            ...
                                            <div class="row">
                                                <div class="col-xl-4">
                                                    <div class="d-flex justify-content-center">
                                                        <img src="assets/media/svg/icons/Shopping/Dollar.svg" width="30" height="30" />
                                                    </div>
                                                    <br />
                                                ...
                                                <div class="col-xl-5">
                                                    <div class="d-flex justify-content-center">
                                                        <img src="assets/media/svg/icons/General/hand-holding.svg" height="30" width="30" />
                                                    </div>
                                                    <br />
                                                    ...
                                                    <div class="d-flex justify-content-around">
                                                        <div>
                                                            <span class="font-weight-bold font-size-xs">
                                                                Balance </span> <br /><span $0 </span>
                                                        </div>
                                                        <div>

                                                            <span class="font-weight-bold font-size-xs">
                                                                1Completed</span><br /><span> $668.9
                                                            </span>
                                                        </div>
                                                        <div>

                                                            <span class="font-weight-bold font-size-xs">
                                                                0Scheduled<span> <br /><span> $0
                                                                    </span>
                                                        </div>
                                                        <div>

                                                            <span class="font-weight-bold font-size-xs">
                                                                0Missed</span> <br /><span> $0
                                                            </span>
                                                        </div>
                                                        <div>

                                                            <span class="font-weight-bold font-size-xs">
                                                                0Cancelled</span> <br /><span>
                                                                $0
                                                            </span>
                                                        </div>
                                                    </div>
                                                ...
                                                <div class="col-xl-3">
                                                    <div class="d-flex justify-content-center">
                                                        <img src="assets/media/svg/icons/General/users-arrow-left.svg" height="20" width="20" />
                                                    </div>
                                                    <br />
                                                    <div class="d-flex justify-content-around">
                                                        <div>
                                                            <span class="text-primary font-size-20">
                                                                LMS Admin
                                                                <i class="icon-1x la la-pen font-size-h1 text-dar"></i>
                                        ...
                                        <div>
                                            <div class="row mt-10">
                                                <div class="col-3">
                                                    <div class="d-flex justify-content-center">
                                                        <i class="icon-xl la la-bank font-size-h1 text-dark"></i>
                                                    </div>
                                                    <br />
                                                    ...
                                                    <div class="text-center">
                                                        ...
                                                        <br />
                                                        <span class="font-weight-bold font-size-s">
                                                            01/01/2001 00:00:00
                                                        </span>
                                                ...
                                                <div class="col-4">
                                                    <div class="d-flex justify-content-center">
                                                        <i class="icon-xl la la-stopwatch font-size-h1 text-dark"></i>
                                                    ...
                                                    <div class="d-flex justify-content-around">
                                                        <div>
                                                            <span class="font-weight-bold font-size-xs">
                                                                Funded At</span> <br /><span> 01/01/2023
                                                            </span>
                                                        </div>
                                                        <div >
                                                            <span class="font-weight-bold font-size-xs">
                                                                Last Payment At</span> <br /><span>2024-01-15
                                                            </span>
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="col-3">
                                                    <div class="d-flex justify-content-center">
                                                        <img src="assets/media/svg/icons/General/briefcase.svg" height="20" width="20" />
                                                    </div>
                                                    <br />

                                                    <div>
                                                        <span class="font-weight-bold font-size-base">
                                                            Payday / Interest Rate: 23% Term : 45 day
                                                        </span>
                                                    </div>
                                                </div>
                                                <div class="col-xl-2">
                                                    <div class="d-flex justify-content-center">
                                                        <img src="assets/media/svg/icons/General/up-down.svg" height="20" width="20" />
                                                    </div>
                                                    <br />
                                                    <div class="d-flex justify-content-lg-between">
                                                        ...
                                                        <div>
                                                            <a data-toggle="modal" data-target="#examplePending"><span class="flaticon2-edit ml-2" /></a>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                            ...
                            <div class="modal fade" id="editLoanApplication" tabindex="-1" role="dialog" aria-labelledby="exampleModalSizeSm" aria-hidden="true">
                                <div class="modal-dialog modal-lg" role="document">
                                    <div class="modal-content">
                                        <div class="modal-header">
                                            <h5 class="modal-title" id="exampleModalLabel">Edit Loan Application</h5>
                                        ...
                                        <div class="modal-body">
                                            <div class="row">
                                                <div class="col-3 font-size-h5 font-weight-bold">
                                                    Select Product
                                                ...
                                                <div class="col-9">
                                                    <div class="form-group">
                                                        <select class="form-control font-size-h5" id="exampleSelect1">
                                                            <option>Flat Interest Bi-weekly</option>
                                                            <option>Flat Interest Monthly</option>
                                                            <option>Payday</option>
                                                            <option>Flat interest Semi-Monthly</option>
                                                            <option>Payday 6-30 days</option>
                                                            <option>Flat Interest Weekly</option>
                                                            <option>PAYDAY TEST2</option>
                                                        </select>
                                                    </div>
                                                </div>
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-9">
                                                    <div class="form-group">
                                                        <input class="form-control font-size-h5" type="date" value="2011-08-19" id="example-date-input">
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                            ...
                            <div class="modal fade" id="exampleProfile" tabindex="-1" role="dialog" aria-labelledby="exampleModalSizeSm" aria-hidden="true">
                                <div class="modal-dialog modal-lg" role="document">
                                    <div class="modal-content">
                                        <div class="modal-header">
                                            <h5 class="modal-title" id="exampleModalLabel">Change Assignee</h5>
                                            <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                                                <i aria-hidden="true" class="ki ki-close"></i>
                                            </button>
                                        </div>
                            ...
                            <div class="modal fade" id="examplePending" tabindex="-1" role="dialog" aria-labelledby="exampleModalSizeSm" aria-hidden="true">
                                <div class="modal-dialog modal-lg" role="document">
                                    <div class="modal-content">
                                        <div class="modal-header">
                                            <h5 class="modal-title" id="exampleModalLabel">Change Loan Application Status</h5>
                                            <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                                                <i aria-hidden="true" class="ki ki-close"></i>
                                            </button>
                                        </div>
                            ...
                            <div class="row">
                                <div class="col-xl-3">
                                    <!--begin::Tiles Widget 9-->
                                    <div class="card card-custom bgi-no-repeat bgi-size-cover" style="height: 420px; width:240px;background-color:#5969ca;">
                                        <!--begin::Body-->
                                        <div class="d-flex flex-column">
                                            <!--begin::Title-->
                                            <span class="font-size-h2 text-white ml-2 mt-4"><a href="./user_page.php" class="text-white"> Summary </a></span>
                                            ...
                                            <div class="row">
                                                <div class="col-6">
                                                    <span class="text-left font-size-base text-white ml-3">
                                                        Doc Signed:
                                                    </span>
                                                </div>
                                                <div class="col-6">
                                ...
                                <div class="col-xl-9">
                                    <div class="example-code">
                                        <ul class="example-nav nav nav-tabs nav-tabs-line nav-tabs-line-2x font-size-h6 nav-tabs-primary" id="myTab" role="tablist">
                                            ...
                                            <li class="nav-item text-center">
                                                <a class="nav-link" data-toggle="tab" href="#tab_bank_details">Bank <br /> Details</a>
                                            </li>
                                            <li class="nav-item text-center">
                                                <a class="nav-link" data-toggle="tab" href="#tab_insights_detail">Insights</a>
                                            </li>
                                            <li class="nav-item text-center">
                                                <a class="nav-link" data-toggle="tab" href="#tab_payment_detail">Payment <br />Scheduling</a>
                                            </li>
                                            <li class="nav-item text-center">
                                        ...
                                        <div class="tab-content">
                                            <div class="tab-pane active" id="example_code_1_html" role="tabpanel">
                                                <div class="row">
                                                    <div class="col-4">
                                                        <span class="font-size-h4 text-dark"> Personal Info</span>
                                                        ...
                                                        <div class="row mt-2 mb-2">
                                                            ...
                                                            <div class="col-8">
                                                                <span class="text-center font-weight-bold text-black">
                                                                    Mike
                                                                </span>
                                                            </div>
                                                        ...
                                                        <div class="row mt-2 mb-2">
                                                            ...
                                                            <div class="col-8">
                                                                <span class="text-center font-weight-bold text-black">
                                                                    123 Test Society, Mal Road, QC,Canada
                                                                </span>
                                                            </div>
                                                    ...
                                                    <div class="col-4">
                                                        <span class="font-size-h4 text-dark">Employment Info</span>
                                                        <hr class="hr border-2 border-bottom-dark" />
                                                        <div class="row mt-2 mb-2">
                                                            <div class="col-6">
                                                                <span class="text-left font-weight-bold text-black">
                                                    ...
                                                    <div class="col-4">
                                                        <span class="font-size-h4 text-dark"> Household Finances</span>
                                                        <hr class="hr border-2 border-bottom-dark" />
                                                        <div class="row mt-2 mb-2">
                                                            <div class="col-6">
                                                                <span class="text-left font-weight-bold text-black">
                                                        ...
                                                        <div class="row mt-2 mb-2">
                                                            ...
                                                            <div class="col-6">
                                                                <span class="text-center font-weight-bold btn-info">
                                                                    No
                                                                </span>
                                                            </div>
                                                    ...
                                                    <table class="table table-separate table-head-custom table-checkable dataTable no-footer dtr-inline font-size-base" id="kt_datatable" role="grid" aria-describedby="kt_datatable_info" style="width: 700px;">
                                                        <thead>
                                                            <tr role="row">
                                                                ...
                                                                <th class="sorting" tabindex="0" aria-controls="kt_datatable" rowspan="1" colspan="1" style="width: 25px;" aria-label="Date Created: activate to sort column ascending">Date Created</th>
                                                                ...
                                                                <th class="sorting" tabindex="0" aria-controls="kt_datatable" rowspan="1" colspan="1" style="width: 30px;" aria-label="Principal: activate to sort column ascending">Principal</th>
                                                                <th class="sorting" tabindex="0" aria-controls="kt_datatable" rowspan="1" colspan="1" style="width: 30px;" aria-label="Intrest: activate to sort column ascending">Intrest</th>
                                                                <th class="sorting_disabled" rowspan="1" colspan="1" style="width: 30px;" aria-label="Actions">Fees</th>
                                                            </tr>
                                                        </thead>
                                                        <tr class="odd">
