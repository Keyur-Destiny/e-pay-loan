                                ...
                                <form class="form">
                                    <div class="card-body">
                                        <div>
                                            ...
                                            <div class="form-group row">
                                                <label class="col-lg-3 font-size-h5 col-form-label">Password</label>
                                                <div class="col-lg-8">
                                                    <input type="password" class="form-control" placeholder="Password" />
                                                </div>
                                            </div>
                                            <div class="form-group row">
                                                <label class="col-lg-3 font-size-h5 col-form-label">Confirm Password</label>
                                                <div class="col-lg-8">
                                            ...
                                            <div class="form-group row">
                                                <label class="col-lg-3 font-size-h5 col-form-label">Role</label>
                                                <div class="col-lg-8">
                                                    <select class="form-control font-size-h6">
                                                        <option class="font-size-h6">Admin</option>
                                                        <option class="font-size-h6">Agent</option>
                                                        <option class="font-size-h6">Collection Agent</option>
                                                    </select>
                                                </div>
                                            </div>
                                            ...
                                            <div class="form-group row">
                                                ...
                                                <div class="col-lg-8">
                                                    <select class="form-control font-size-h6">
                                                        ...
                                                        <option class="font-size-h6">Credit Sense</option>
