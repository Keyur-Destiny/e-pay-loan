                                    ...
                                    <div class="card-body">
                                        <div>
                                            <div class="form-group row">
                                                <label class="col-lg-3 font-size-h6 col-form-label">Name</label>
                                                <div class="col-lg-8">
                                                    <input type="text" class="form-control" placeholder="Name" />
                                                </div>
                                            </div>
                                            <div class="form-group row">
                                                <label class="col-lg-3 font-size-h6 col-form-label">Type</label>
                                                <div class="col-lg-8">
                                                    <select class="form-control font-size-h6">
                                                        <option class="font-size-h6">Administrator Fee</option>
                                                        <option class="font-size-h6">Late Fee</option>
                                                        <option class="font-size-h6">NSF</option>
                                                        <option class="font-size-h6">Origination Fee</option>
                                                        <option class="font-size-h6">Past Due Interest</option>
                                                        <option class="font-size-h6">Pay Off Fee</option>
                                                    </select>
                                                </div>
                                            </div>
                                            <div class="form-group row">
                                                <label class="col-lg-3 font-size-h6 col-form-label">Calculation basis</label>
                                                <div class="col-lg-8">
                                                    <select class="form-control font-size-h6">
                                                        <option class="font-size-h6">Remaining Principal</option>
                                                        <option class="font-size-h6">Loan amount</option>
                                                        <option class="font-size-h6">Disbursement amount</option>
                                            ...
                                            <div class="form-group row">
                                                <label class="col-lg-3 font-size-h6 col-form-label">Amonut</label>
                                                <div class="col-lg-8">
                                                ...
                                                <div class="form-group row">
                                                    <label class="col-lg-3 font-size-h6 col-form-label">Installment past due</label>
                                                    <div class="col-lg-8">
                                                        <input type="number" class="form-control" placeholder="Installment past due" />
                                                    </div>
                                                </div>
